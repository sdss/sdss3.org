...
radial velocites may be in doubt, or simply to make the user aware of possible anomalies
...
the measured radial velocites are reasonably OK, whereas the other
one is to check if a spectrum is needed for visual inspection.</p>

<h2>Flags for checking the stellar parameters and radial velocites</h2>
...
<p>The second
category of flags are the cautionary flags, which are provided for user
...
considered well determined.</p>
  ...
  <table class="common">
      ...
      <tr>
        ...
        <td> Difference between adopted <i>T</i><sub>eff</sub> and g-z color-based <i>T</i><sub>eff</sub> &gt; 500 K </td>
        <td style="text-align: center;"> Cautionary </td>
        <td style="text-align: center;"> Yes </td>
      </tr>
      <tr>
...
flag are as follows.</p>
  ...
  <table class="common">
      ...
      <tr>
        <td> T </td>
        <td> Temperature difference between <i>T</i><sub>eff</sub>(adopted) and g-z color-based <i>T</i><sub>eff</sub> is &gt; 500 K </td>
      </tr>
      <tr>
        <td> t </td>
