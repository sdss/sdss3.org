...
href="dr8/glossary.php#plate">plates</a> are designed
and placed relative to each other. This procedure involves optimizing
both the placement of <a
href="dr8/glossary.php#fiber">fibers</a> on individual
...
<ul>
<li><a href="dr8/algorithms/tiling.php#survey">Spectro Survey Overview</a></li>
<li><a href="dr8/algorithms/tiling.php#tiling">What is tiling?</a></li>
<li><a href="dr8/algorithms/tiling.php#fiber_placement">Fiber Placement</a></li>
<li><a href="dr8/algorithms/tiling.php#collisions">Dealing with Fiber Collisions</a></li>
<li><a href="dr8/algorithms/tiling.php#tile_placement">Tile Placement</a></li>
<li><a href="dr8/algorithms/tiling.php#tech_details">Technical Details</a></li>
<li><a href="dr8/algorithms/tiling.php#tiling_window">Tiling Window</a></li>
</ul>
...
<p><a href="dr8/algorithms/tiling.php#Top">[Back to top]</a></p>
...
known in SDSS parlance as a <a href="dr8/glossary.php#tile_region">tiling region</a>. </p>
...
flow algorithm of the <a href="dr8/algorithms/tiling.php#fiber_placement">above section</a> to the
set of decollided
...
explained in <a href="dr8/algorithms/target_selection.php">the targetting pages</a>, QSOs are
...
described in the <a href="dr8/algorithms/target_selection.php">targetting pages</a>). They consist
...
<a href="dr8/glossary.php#survey_coords">survey
...
href="dr8/glossary.php#tilable">tilable targets</a>
...
href="dr8/algorithms/masks.php">photometric imaging mask</a>)</li>
<li>Target selection (requires understanding the <a
href="dr8/algorithms/target_selection.php">target selection algorithms</a>)</li>
<li>Tiling (the algorithm is described above)</li>
<li>Spectroscopic completeness (whether or not <a href="dr8/spectro/">
...
and the solutions are cinldued in the data release. </p>
...
<p>The <a href="dr8/data_access.php#CAS">Catalog Archive
