...
<ul>
<li><a href="dr8/algorithms/fluxcal.php#intro">Introduction</a></li>
<li><a href="dr8/algorithms/fluxcal.php#counts2mag">Calibration Parameters</a></li>
<li><a href="dr8/algorithms/fluxcal.php#calib_status">Photometric Calibration Flags</a></li>
<li><a href="dr8/algorithms/fluxcal.php#SDSStoAB">SDSS Mags to AB Mags</a></li>
<li><a href="dr8/algorithms/fluxcal.php#SDSStoflux">SDSS Mags to fluxes</a></li>
<li><a href="dr8/algorithms/fluxcal.php#assessment">QA Figures</a></li>
</ul>
...
<p><a href="dr8/algorithms/fluxcal.php#Top">[Back to top]</a></p>
...
<p>The photometric calibration status flags are detailed <a href="dr8/algorithms/bitmask_calib_status.php">here</a>; we describe their recommended
...
&amp; Gunn 1983)</a>, by which a magnitude 0 object should have the
same counts as a source of F<sub>&nu;</sub> =
...
comparison to the STIS standards of <a
href="http://adsabs.harvard.edu/abs/2001AJ....122.2118B">Bohlin,
Dickinson, &amp; Calzetti (2001)</a> and confirmed by SDSS photometry and
spectroscopy of fainter hot white dwarfs, is that the <var>u</var>
band zeropoint is in error by 0.04 mag, <var>u</var><sub>AB</sub> =
<var>u</var><sub>SDSS</sub> - 0.04 mag, and that <var>g, r</var>, and
<var>i</var> are close to AB.  These statements are certainly not
...
<a href="http://adsabs.harvard.edu/abs/2010AJ....139.1628D">
Doi et al. (2010)</a>.  The <var>z</var> band zeropoint is
...
<var>z</var><sub>SDSS</sub> + 0.02 mag.  The large shift in the
<var>u</var> band was expected because the adopted magnitude of the
SDSS standard BD+17 in <a
href="http://adsabs.harvard.edu/abs/1996AJ....111.1748F">Fukugita
et al. (1996)</a> was computed at zero airmass, thereby making the
assumed <var>u</var> response bluer than that of the USNO system
response.</p>


<p> Note that our <i>relative</i>
photometry is quite a bit better than these numbers would imply;
repeat observations and simulations of the ubercal pipeline show that our calibrations are ~1% in <var>gri</var> and
~2% in <var>u</var> and <var>z</var>.</p>
...
AB system. Assuming you know the <a href="dr8/algorithms/fluxcal.php#SDSStoAB">correction from
...
<p>To obtain a flux density from SDSS data, you need to work out
      ...
      relations given <a href="dr8/algorithms/fluxcal.php#counts2mag">above</a>). This number is
...
href="dr8/algorithms/fluxcal.php#SDSStoAB">description of SDSS to AB conversion</a>
above.</p>
...
href="http://data.sdss3.org/sas/dr8/groups/boss/calib/dr8_final/plots/">available
