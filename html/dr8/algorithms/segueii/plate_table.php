...
<p>The SEGUE sample consists primarily of two surveys (namely SEGUE-1 and SEGUE-2) which
in turn encompass a number of observing programs. These parameters are listed in the PlateX table in
CASJobs as <i>survey</i> and <i>programname</i>. </p>

<p>For most SEGUE plates, <i>survey</i> will be <i>segue1</i>, <i>segue2</i>, or <i>sdss</i>. For later data releases,
it could also be <i>boss</i>, <i>marvels</i>, or <i>apogee</i>. The <i>programname</i> parameter gives information about
both where and why a particular plate is targeted. The programs are listed below: </p>

<table class="common">
<caption>SEGUE 1 and 2 Programnames</caption>
<tr><th>plateX.programname</th><th>Details</th></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segue">segue</a>            </td><td> segue-1 bright, placed without regard to known substructure </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segue">seguefaint</a>       </td><td> segue-1 faint plate, placed without regard to know substructure </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segue2">segue2</a>          </td><td> segue-2 plate. No bright/faint distinction. Always placed without regard to known substructure </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segtest">segtest</a>        </td><td> special target selection for testing purposes </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segcluster">segcluster</a>  </td><td> plate placed at the location of a globular or open cluster </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segpointed">segpointed</a>  </td><td> bright segue-1 plate placed at the probable location of MW substructure </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#segpointed">segpointedf</a> </td><td> faint segue-1 plate placed at the probable location of MW substructure </td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#seglowlat">seglowlat</a>    </td><td> segue-1 bright plate placed at low Galactic latitude and designed with the low latitude targeting strategy</td></tr>
<tr><td> <a href="dr8/algorithms/segueii/plate_table.php#seglowlat">seglowlatf</a>   </td><td> segue-1 faint plate placed at low Galactic latitude and designed with the low latitude targeting strategy</td></tr>
</table>

<hr />

<h2 id="segue">Program: segue</h2>

<p>The plates under the program name <i>segue</i> are the bright plates from the
segue1 survey. Corresponding faint plates are listed as <i>seguefaint</i>. These plates are placed
...
<h2 id="segtest">Program: segtest</h2>

<p>The plates under the program name <i>segtest</i> use a special target
selection algorithm used for testing the overall SEGUE programs. </p>
...
<h2 id="segpointed">Program: segpointed</h2>
...
plates, labeled <i>segpointedf</i>. </p>
...
<h2 id="segcluster">Program: segcluster</h2>
...
Fibers from these plates are used to spectroscopically target cluster members. Al
...
when accounting for target selection. </p>
...
<h2 id="seglowlat">Program: seglowlat</h2>
...
<a href="dr8/algorithms/segueii/segue_target_selection.php#lowlat">SEGUE Target Selection </a> page.</p>
