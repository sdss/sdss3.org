...
You can use the SDSS <a href="http://skyserver.sdss3.org/dr8/en/">Catalog Archive Server</a> to generate a finding
chart to help plan these observations.</p>

<ol>

<li>Go to the <a href="http://skyserver.sdss3.org/dr8/en/tools/chart/chart.asp">Finding Chart</a> tool.
