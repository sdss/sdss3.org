...
<p>The SDSS does automatic processing to determine the reliability of the imaging data
   ...
   SDSS's <a href="http://skyserver.sdss3.org/dr8">Catalog
...
<p>By using several flags together, you can search for only objects that have clean photometry.
   (<a href="dr8/help/flags.php#clean">skip to clean photometry search guide)</a></p>

<p>Flags are yes/no parameters (see the <a href="dr8/algorithms/bitmasks.php">bitmask</a> page). If a certain flag (such as <i>Saturated</i>) is present for an object,
...
<p>You can view flag names directly with the <a
   href="http://skyserver.sdss3.org/dr8/en/tools/explore/obj.asp">
...
<h2>Jump to</h2>
<ul>
    <li><a href="dr8/help/flags.php#single">Flags for a single object</a></li>
    <li><a href="dr8/help/flags.php#interpret">Interpret Flags</a></li>
    <li><a href="dr8/help/flags.php#query">Flags in a Query</a></li>
    <li><a href="dr8/help/flags.php#sql">Flags with SQL</a></li>
    <li><a href="dr8/help/flags.php#clean">Clean Photometry</a></li>
</ul>
...
<li>Use the <a href="http://skyserver.sdss3.org/dr8/en/tools/explore/obj.asp">Explore</a> tool
to look at a single object. See the <a href="dr8/help/getimage.php">How do I get an image of my favorite object?</a> tutorial to learn how to use the Explore tool.</li>
...
<li>Look at <b>flags</b>, the third row of data just below the object's coordinates. You will see the
       ...
       <a href="http://skyserver.sdss3.org/dr8/en/help/browser/browser.asp">Schema Browser</a> for what they mean. Instructions
       for using the Schema Browser are in the next section, <a href="dr8/help/flags.php#interpret">Interpret Flags</a>.</li>
...
<li>Use the <a href="http://skyserver.sdss3.org/dr8/en/help/browser/browser.asp">Schema Browser</a>
...
<li>The 13<sup>th</sup> entry in the table is <b>flags</b>. Click on the <img src="http://skyserver.sdss3.org/dr8/en/help/docs/images/info.gif" style="float:none;vertical-align:bottom;"  alt="Link to PhotoFlags" />
...
<p>You can search through flags as part of your searches with the <a href="http://skyserver.sdss3.org/dr8/en/tools/search/iqs.asp">Imaging
...
<li>Go to the <a href="http://skyserver.sdss3.org/dr8/en/tools/search/iqs.asp">Imaging Query Form</a>. From the astronomers'
       main page, look under <b>Search Tools</b>. For more on how to use the Imaging Query Form, see the guide
       <a href="dr8/help/getdata.php">How do I find data for all objects in a given RA/Dec/Magnitude/Absolute Magnitude
       range?</a></li>
...
<li>Go to the <a href="http://skyserver.sdss3.org/dr8/en/tools/search/sql.asp">SQL Search</a> tool, under the
...
href="http://skyserver.sdss3.org/dr8/en/help/docs/realquery.asp#cleanStars"> this one </a> and  <a href="http://skyserver.sdss3.org/dr8/en/help/docs/realquery.asp#cleanGals"> this one </a></p>.
