...
href="http://skyserver.sdss3.org/dr8/en/">Catalog
...
<a href="http://skyserver.sdss3.org/dr8/en/tools/crossid/crossid.asp">Imaging Cross-Identification</a>
...
href="http://skyserver.sdss3.org/dr8/en/tools/crossid/upload.asp">Cross-ID tool</a></h3>
...
<li><p>In the <i>Search Type</i> dropdown menu, choose the type of search that you want to do. The options are:</p>
   ...
   <ul>
     <li><i>The nearest primary object</i>:   The single <a href="dr8/glossary.php#primary">primary</a>
     ...
     whether or not it is a <a href="dr8/glossary.php#primary">primary</a>
     observation.</li>

     <li><i>All nearby objects</i>: All objects within your specified search radius.</li>

     <li><i>All nearby primary objects</i>:  All <a href="dr8/glossary.php#primary">primary</a> observations of
...
<a href="http://skyserver.sdss3.org/dr8/en/tools/explore/obj.asp">Explore</a> tool, which will
...
<h3 id="thumbnails">Get SDSS <a href="http://skyserver.sdss3.org/dr8/en/tools/chart/list.asp">thumbnails</a></h3>
...
the <a href="http://skyserver.sdss3.org/dr8/en/tools/chart/list.asp">Image List</a>
...
href="http://skyserver.sdss3.org/dr8/en/tools/chart/navi.asp">Navigate</a>
...
<a href="http://skyserver.sdss3.org/dr8/en/tools/explore/obj.asp">Explore</a>
