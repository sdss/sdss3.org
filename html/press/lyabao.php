<?php include '../header.php'; echo head('The Great Space Coaster','November 13, 2012'); ?>

<h2>Astronomers measure the Universe's deceleration before dark energy took over</h2>

<p>For the past five billion years, the expansion of the Universe has been
...
just three billion years after the Big Bang.</p>

<p>"If we think of the Universe as a roller coaster, then today we are rushing
downhill, gaining speed as we go," says Nicol&aacute;s Busca of the Laboratoire
...
tells us about the time when the Universe was climbing the hill &mdash; still
being slowed by gravity."</p>

<table class="centerfigure" style="width:612px;">
    <tr>
        <td>
    <span class="imgoptions">Other versions:</span>
	    <span style="font-size:small">
        &nbsp;&nbsp;
        <a href="press/images/bw/lyabao.illo4.bw.jpg" class="imgoptions">B/W</a>
        &nbsp;-&nbsp;
        <a href="press/images/fullsize/lyabao.illo4.300dpi.tif" class="imgoptions">300 DPI color TIF</a>
		&nbsp;-&nbsp;
        <a href="press/images/fullsize/bw/lyabao.illo4.300dpi.bw.tif" class="imgoptions">300 DPI B/W TIF</a>
    </span>
		</td>
	</tr>
    <tr>
        <td>
            <img src="press/images/lyabao.illo4.jpg" alt="An illustration contained
			in a purple rectangle. At the left edge of the rectangle are many red
			and yellow dots. Thin lines come out of the dots to the right. The
			lines pass through a slice of intergalactic gas shown as a purple-and-gold
			colored rectangle." />
        </td>
    </tr>
    <tr>
        <td>
			...
			<p style="color:yellow;">SDSS-III was able to measure the expansion rate of the distant Universe by using quasars to probe the distribution of hydrogen along the line of sight from the each quasar (red dots in the upper left) to the Sloan Foundation 2.5-m Telescope on Earth (abstractly represented as the plane in the lower right).<br />
			<span id="shortillo" style="display:block">
			<a href="javascript:longer('illo');">+ MORE +</a></span></p>


			<div id="longillo" style="display:none">
				<p style="color:yellow;">Light rays from distant quasars (dots at left)
				...
				of small absorption lines in the observed spectrum.</p>

				<p style="color:yellow;">These lines can be interpreted to make a map
				...
				a detailed three-dimensional map of the distant universe.</p>

				<p style="color:yellow;">In this illustration, the dots at the far left
				...
				<a href="javascript:shorter('illo');">- LESS -</a>
				</p>
			</div>

	        <p style="color:yellow;"><b>Illustration Credit:</b> Zosia Rostomian, LBNL;
			Nic Ross, BOSS Lyman-alpha team, LBNL; Springel et al, Virgo Consortium
			and the Max Planck Institute for Astrophysics</p>
        </td>
    </tr>
</table>

<p>
The results were presented in a paper submitted to the journal <i>Astronomy
&amp; Astrophysics</i>; <a href="http://arxiv.org/abs/1211.2616">the paper was also posted
today on the arXiv.org preprint site</a>. The new measurement is based on data from
the <a href="surveys/boss.php">Baryon Oscillation Spectroscopic Survey (BOSS)</a>,
...
quasar's light. Measuring this absorption &mdash; a phenomenon known as the
Lyman-alpha Forest &mdash; yields a detailed picture of the gas between us
and the quasar.
</p>
...
subtle variations of BAOs. But the new map is big enough  &mdash; it
...
<table class="centerfigure" style="width:612px;">
    ...
    <span class="imgoptions">Other versions:</span>
	    <span style="font-size:small">
        &nbsp;&nbsp;-&nbsp;&nbsp;
        <a href="press/images/bw/lyabao.graph5.bw.jpg" class="imgoptions">B/W JPG</a>
        &nbsp;&nbsp;-&nbsp;&nbsp;
        <a href="press/images/fullsize/lyabao.graph5.300dpi.tif" class="imgoptions">300 DPI color TIFF</a>
        &nbsp;&nbsp;-&nbsp;&nbsp;
        <a href="press/images/fullsize/bw/lyabao.graph5.300dpi.bw.tif" class="imgoptions">300 DPI B/W TIFF</a>
    </span>
		</td>
	</tr>
    <tr>
        <td>
            <img src="press/images/lyabao.graph5.jpg" alt="A graph in white on a black
			background. Data points are shown on the graph as squares. A curved line
			passes through the data points, first decreasing, then increasing." />
        </td>
    </tr>
    <tr>
        <td>
			<p style="color:yellow;">A new measurement from SDSS-III BOSS reaches twice as far into the past as previous direct measurements of the expansion rate (illustrated by the red dot on the left-hand side).  The expansion rate of the Universe was slowing down 10 billion years ago, and started to speed up due to the influence of dark energy 6 billion years ago.
<br />

			<span id="shortgraph" style="display:block">
				<a href="javascript:longer('graph');">+ MORE +</a>
			</span>
			</p>

			<div id="longgraph" style="display:none">

				<p style="color:yellow;">Until recently, three-dimensional maps by
				...
				time when the expansion of the Universe was already accelerating.</p>

				<p style="color:yellow;">The numbers along the bottom of the graph
				...
				measurements appear as data points toward the right of the graph.</p>

				<p style="color:yellow;">The new SDSS-III measurements, shown as the
				big red point to the far left, have now probed the structure of the early
				Universe at a time when expansion was still slowing down.<br />
				<a href="javascript:shorter('graph');">- LESS -</a>
				</p>
				</div>


            <p style="color:yellow;"><b>Credit:</b> Zosia Rostomian, LBNL; Nic Ross, BOSS Lyman-alpha team, LBNL</p>
        </td>
    </tr>
</table>
...
understanding of the Universe &mdash; that dark energy is a constant part of space
...
of the galaxies in the Universe &mdash; but that as the Universe expanded, the
...
Georges Lema&icirc;tre first measured the expansion rate of the nearby Universe,
...
<p>
Nicol&aacute;s Busca summarizes: "It looks like the roller coaster crested the hill
...
<h2 id="papers">Paper announcing the results</h2>

<p>N. G. Busca, T. Delubac, J. Rich, S. Bailey, A. Font-Ribera, D. Kirkby, J.-M. Le Goff,
M.M. Pieri, A. Slosar, &Eacute;. Aubourg, J. E. Bautista, D. Bizyaev, M. Blomqvist,
A. S. Bolton, J. Bovy, H. Brewington, A. Borde, J. Brinkmann, B. Carithers, R. A. C. Croft,
K. S. Dawson, G. Ebelke, D. J. Eisenstein, J.-C. Hamilton, S. Ho, D. W. Hogg, K. Honscheid,
K.-G. Lee, B. Lundgren, E. Malanushenko, V. Malanushenko, D. Margala, C. Maraston, K. Mehta,
J. Miralda-Escud&eacute;, A. D. Myers, R. C. Nichol, P. Noterdaeme, M. D. Olmstead,
D. Oravetz, N. Palanque-Delabrouille, K. Pan, I. P&acirc;ris, W. J. Percival, P. Petitjean,
N. A. Roe, E. Rollinde, N. P. Ross, G. Rossi, D. J. Schlegel, D. P. Schneider, A. Shelden,
E. S. Sheldon, A. Simmons, S. Snedden, J. L. Tinker, M. Viel, B. A. Weaver, D. H. Weinberg,
M. White, C. Y&egrave;che, D. G. York, G.-B. Zhao, 2012,<br />
<a href="http://arxiv.org/abs/1211.2616">Baryon Acoustic Oscillations in the Ly-&alpha; forest of BOSS quasars</a>,<br />
Submitted to <i>Astronomy &amp; Astrophysics</i>, <a href="http://arxiv.org/abs/1211.2616">
arXiv:1211.2616</a>.</p>
...
<p>Funding for SDSS-III has been provided by the Alfred P. Sloan Foundation, the
...
http://www.sdss3.org/.</p>

<p>SDSS-III is managed by the Astrophysical Research Consortium for the Participating
...
Washington, and Yale University.</p>


<h3>Contacts:</h3>
<ul>
<li>Nicol&aacute;s Busca,
	Laboratoire Astroparticule et Cosmologie, France,
	ngbusca -at apc.univ-paris7.fr, +33 1 57 27 60 57</li>

<li>James Rich,
	Centre de Saclay Institute of Research into the Fundamental Laws of the Universe (IRFU),
	james.rich -at- cea.fr</li>

<li><a href="http://www.slosar.com/aslosar/">An&#158;e Slosar</a>,
	Brookhaven National Laboratory
	anze -at- bnl.gov</li>

<li><a href="http://www.physics.utah.edu/~kdawson/">Kyle Dawson</a>,
	University of Utah,
    kdawson -at- astro.utah.edu, +1 801 581 4785</li>

<li><a href="http://www.physicsandastronomy.pitt.edu/people/michael_wood-vasey">
	Michael Wood-Vasey</a>, SDSS-III Spokesperson, University of Pittsburgh,
    wmwv -at- pitt.edu, +1 412 624 2751</li>

<li>Jordan Raddick, SDSS Public Information Officer,
