<?php include '../header.php'; echo head('This is Your Galaxy: New data help astronomers explore the hidden Milky Way','July 31, 2013'); ?>

<p>Today, astronomers with the Sloan Digital Sky Survey III (SDSS-III) released a new online
public data set featuring 60,000 stars that are helping to tell the story of how our Milky Way galaxy
formed.</p>

<p>The highlight of today's "Data Release 10" is a new set of high-resolution stellar spectra &mdash;
measurements of the amount of light given off by a star at each wavelength &mdash; using infrared light,
invisible to human eyes but able to penetrate the veil of dust that obscures the center of the Galaxy.</p>



<table class="centerfigure" style="width:600px;">
    <tr>
        <td>
    <span class="imgoptions">Other versions:</span>
	    <span style="font-size:small">
        &nbsp;&nbsp;
        <a href="press/images/bw/dr10.coverspec.bw.v3.jpg" class="imgoptions">B/W</a>
        &nbsp;-&nbsp;
        <a href="press/images/fullsize/dr10.coverspec.300dpi.v3.jpg" class="imgoptions">300 DPI color</a>
		&nbsp;-&nbsp;
        <a href="press/images/fullsize/bw/dr10.coverspec.300dpi.bw.v3.jpg" class="imgoptions">300 DPI B/W</a>
    </span>
		</td>
	</tr>
    <tr>
        <td>
            <img src="press/images/dr10.coverspec.v3.jpg" alt="A map of the Milky Way with spectra from Data Release 10" />
        </td>
    </tr>
    <tr>
        <td>
...
<!--			<div id="longplatecaption" style="display:none;">-->
			...
			<p style="color:yellow;">The map shows an infrared view of the Milky Way as seen from
...
<p>"This is the most comprehensive collection of infrared stellar spectra ever made," said Steven
...
curtain on the hidden Milky Way."</p>

<p>The new spectra are the first data released by the SDSS-III's Apache Point Observatory Galactic
Evolution Experiment (APOGEE), an effort to create a comprehensive census of our Milky Way galaxy.</p>

<p>"A star's spectrum is a powerful tool for learning about the star &mdash; it tells us key details
...
instead of just knowing their height and weight."</p>

<p>The question of how our Milky Way galaxy formed has been the subject of scientific speculation
and debate for hundreds of years. APOGEE's three-dimensional map will provide key information for
resolving central questions about how our galaxy formed over the many billions of years of its history.</p>

<p>The Milky Way currently has three main parts: a high-density oblong bulge in the center, the
...
critical effort to maximize APOGEE's scientific potential by selecting the best possible sample of stars.</p>

<p>If you look up at the sky from a dark site, far away from the overwhelming glow of city lights, the
...
distant parts of the Milky Way.</p>

<p>Because of this dust, previous studies of stars in the Milky Way have been limited in their
...
<p>Observing tens of thousands of stars is a daunting, time-consuming task. To accomplish its goal
...
instrument design team. "That technology is critical to APOGEE's success."</p>
...
<table class="figure" style="width:432px;">
    ...
    <tr>
        <td>
            <img src="press/images/dr10.apogeespectrograph.jpg" alt="Four people in white clean suits and masks stand around the APOGEE spectrograph, a black cylinder about a meter long" />
        </td>
    </tr>
    <tr>
        <td>
<!--            <div id="shortplatecaption" style="display:block;">-->
			...
			<p style="color:yellow;">A photo of four SDSS-III scientists working on the APOGEE
            spectrograph.
<!--			<a href="javascript:longer('platecaption')">+ MORE +</a>-->
			</p>
...
<!--			<div id="longplatecaption" style="display:none;">-->
			...
			<p style="color:yellow;">Left to right: Garrett Ebelke (Apache Point Observatory),
...
<p>APOGEE's spectra of stars will help unlock the history of our galaxy, and the key is learning
...
generations of stars had time to create those heavy elements.</p>

<p>"By finding which parts of the Galaxy contain older versus newer stars, and by putting this
...
coordinated all of the APOGEE observations.</p>

<p>APOGEE data also provide a rich context for investigating a wide range of questions about the stars
...
to detect the subtle stellar motions caused by orbiting planets.</p>

<p>Data Release 10 also publishes another 685,000 spectra from the SDSS-III Baryon Oscillation
...
what dark energy might be.</p>

<p>SDSS-III is a six-year survey of nearby stars, the Milky Way galaxy, and the distant cosmos.
...
<a href="http://www.sdss3.org/dr10">http://www.sdss3.org/dr10</a>.</p>

<!--
<h2 id="papers">Published Paper for Data Release 9</h2>

<p>SDSS-III Collaboration: Ahn C. P. et al. 2012, <a href="http://arxiv.org/abs/1207.7137">The
Ninth Data Release of the Sloan Digital Sky Survey: First Spectroscopic Data from the SDSS-III
Baryon Oscillation Spectroscopic Survey</a>, submitted to
<a href="http://iopscience.iop.org/0067-0049/"><i>Astrophysical Journal
Supplement Series</i></a> and available on the <a href="http://arxiv.org/abs/1207.7137">arXiv
preprint server (1207.7137)</a>.</p>-->
<p>&nbsp;</p>
...
The SDSS-III web site is <a href="http://www.sdss3.org">http://www.sdss3.org</a> .</p>
...
of Washington, and Yale University.</p>


<h3>Contacts:</h3>
<ul>
<li>Steven R. Majewski, University of Virginia,
   srm4n -at- virginia.edu, 1-434-924-4893</li>

<li>Jon Holtzman, New Mexico State University,
   holtz -at- nmsu.edu, 1-575-646-8181</li>

<li>Gail Zasowski, The Ohio State University,
   gail.zasowski -at- gmail.com, 1-614-292-3099</li>

<li>John Wilson, University of Virginia,
   jcw6z -at- virginia.edu, 434-924-4907</li>
