<?php include '../header.php'; echo head('So These Stars Orbit in a Bar...','December 19, 2012'); ?>

<h2>Astronomers identify the stellar patrons of the Milky Way bar</h2>

<p>Forget the restaurant at the end of the Universe &mdash; astronomers now have the clearest
understanding yet of the bar at the center of the Milky Way.</p>

<p>Scientists with the Sloan Digital Sky Survey III (SDSS-III) have announced the discovery
...
understand the whole Galaxy, even out here in the spiral arms."</p>

<table class="centerfigure" style="width:698px;">
    <tr>
        <td>
 ...
 <!--       &nbsp;&nbsp;
        ...
        &nbsp;&nbsp;
        <a href="press/images/fullsize/mwbar.sideview.300dpi.jpg" class="imgoptions">
		300 DPI color JPG</a>
<!--		&nbsp;-&nbsp;
    ...
    <tr>
        <td>
            <img src="press/images/mwbar.sideview.jpg" alt="A multicolored false-color view
			of the inner Milky Way where red indicates more stars. The inner Milky Way
			appears as an ellipse with lines extending from each side. Over the left and
			top of that image are white cirlces showing SDSS-III's observations. Some cirlces have
			Xs indicating that high-speed stars were found there. On the right are gray circles
			with dots." />
        </td>
    </tr>
    <tr>
        <td>
			...
			<p style="color:yellow;">A map of the innermost Milky Way, with circles
			...
			stars moving toward the Earth.</p>

<!--	<span id="shortillo" style="display:block">
			<a href="javascript:longer('illo');">+ MORE +</a></p>
			</span>
	        ...
	        <p style="color:yellow;"><b>Illustration Credit:</b> David Nidever (University of
			Michigan / University of Virginia) and the SDSS-III Collaboration.
			Background image from the
			<a href="http://www.ipac.caltech.edu/2mass/gallery/showcase/allsky_stars/enlarged.html">
			Two-Micron All Sky Survey Image Mosaic</a> (Infrared Processing and
			Analysis Center/Caltech &amp; University of Massachusetts).</p>
        </td>
    </tr>
</table>
...
near the center of the Milky Way. The center of our Galaxy is 30,000 light-years away &mdash; close
by cosmic standards &mdash; yet we know surprisingly little about it, because the Galaxy's
...
<p>
In a paper published recently in the <i>Astrophysical Journal</i>, a worldwide team of
...
fraction of stars in the inner Galaxy are moving away from us quickly &mdash; about 10 percent
...
midplane of the Galaxy &mdash; suggesting that these measurements of fast central stars are not
just a statistical fluke, but really are a feature of our Galaxy.
</p>


<table class="centerfigure" style="width:539px;">
    <tr>
        <td>
    <span class="imgoptions">Other versions:</span>
	    <span style="font-size:small">
 <!--       &nbsp;&nbsp;-&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;
        <a href="press/images/fullsize/mwbar.topview.300dpi.jpg" class="imgoptions">
		300 DPI color JPG</a>
<!--        &nbsp;&nbsp;-&nbsp;&nbsp;
    ...
    <tr>
        <td>
            <img src="press/images/mwbar.topview.jpg" alt="A color drawing of the Milky Way
			galaxy with long red arrows pointing out of the central bar." />
        </td>
    </tr>
    <tr>
        <td>
			<p style="color:yellow;">An artist's impression of what the Milky Way might look
			...
			discovered by SDSS-III. The dashed arrows show the stars moving <em>toward</em>
...
<!--			<span id="shortgraph" style="display:block">
            ...
            <p style="color:yellow;"><b>Credit:</b> Jordan Raddick (Johns Hopkins University)
			and Gail Zasowski (The Ohio State University / University of Virginia).
			<a href="http://www.spitzer.caltech.edu/images/1923-ssc2008-10a-A-Roadmap-to-the-Milky-Way">
			Milky Way artist's concept</a> by NASA/JPL-Caltech/R. Hurt (SSC-Caltech).</p>
        </td>
    </tr>
</table>
...
latest computer models of the Galaxy &mdash; and the observations matched the predictions
...
<p>
D.L. Nidever, G. Zasowski, S.R. Majewski, J. Bird, A.C. Robin, I. Martinez-Valpuesta,
R.L. Beaton, R. Sch&ouml;nrich, Ralph; M. Schultheis, J.C. Wilson, M.F. Skrutskie,
R.W. O'Connell, M. Shetrone, R.P. Schiavon, J.A. Johnson, B. Weiner, O. Gerhard, D.P. Schneider,
C. Allende Prieto, K. Sellgren, D. Bizyaev, H. Brewington, J. Brinkmann, D.J. Eisenstein,
P.M. Frinchaboy, A.E. Garc&iacute;a P&eacute;rez, J. Holtzman, F.R. Hearty, E. Malanushenko,
V. Malanushenko, D. Muna, D. Oravetz, K. Pan, A. Simmons, S. Snedden, and B.A. Weaver, 2012,<br />
<a href="http://adsabs.harvard.edu/abs/2012ApJ...755L..25N">The Apache Point Observatory
Galactic Evolution Experiment: First Detection of High-velocity Milky Way Bar Stars</a>,<br />
<i>Astrophysical Journal Letters, 755</i>(2), L25,
<a href="http://iopscience.iop.org/2041-8205/755/2/L25/">doi:10.1088/2041-8205/755/2/L25</a>.</p>
...
<h3>Contacts:</h3>
<ul>
<li><a href="http://www.lsa.umich.edu/astro/people/ci.nideverdavid_ci.detail">David Nidever</a>,
	University of Michigan,
	dnidever -at- umich.edu, 734-615-6141</li>

<li><a href="http://astronomy.osu.edu/people/zasowski">Gail Zasowski</a>,
	The Ohio State University,
	gail.zasowski -at- gmail.com, 614-292-6925</li>

<li><a href="http://www.souleros.com/srm/index.php">Steven Majewski</a>,
	University of Virginia,
	srm4n -at- virginia.edu, 434-924-4893</li>
...
<li><a href="http://www.physicsandastronomy.pitt.edu/people/michael_wood-vasey">
    ...
    wmwv -at- pitt.edu, 412-624-2751</li>

<li>Jordan Raddick, SDSS Public Information Officer,
    raddick -at- jhu.edu, 410-516-8889</li>
</ul>
