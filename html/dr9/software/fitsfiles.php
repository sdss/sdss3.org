...
<a href="dr9/software/fitsfiles.php#idl">IDL</a> and <a href="dr9/software/fitsfiles.php#python">Python</a>.</p>
...
<a href="dr9/software/goddard_doc.php#MRDFITS"><code>mrdfits</code></a>
and <a href="dr9/software/goddard_doc.php#MWRFITS"><code>mwrfits</code></a>.
The Goddard utilities are included in the <a href="dr9/software/idlutils.php">idlutils</a> package,
...
<a href="dr9/software/fitsfiles.php#largefiles">below</a>. This package
...
d = fitsio.read('spAll-v5_4_45.fits', columns=columns)
</pre>
...
<pre>
import pyfits
fx = pyfits.open('spAll-v5_4_45.fits', memmap=True)
d = fx[1].data
</pre>

<p>In IDL, the routine
<a href="dr9/software/idlutils_doc.php#HOGG_MRDFITS"><code>hogg_mrdfits</code></a>
is available as part of the <a href="dr9/software/idlutils.php">idlutils</a> package.
