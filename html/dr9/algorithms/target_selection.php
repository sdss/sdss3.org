...
<ul>
<li><a href="dr9/algorithms/target_selection.php#main">Main Galaxy Sample</a></li>
<li><a href="dr9/algorithms/target_selection.php#lrg">Luminous Red Galaxies</a></li>
<li><a href="dr9/algorithms/target_selection.php#qso">Quasars</a></li>
<li><a href="dr9/algorithms/target_selection.php#stars">Stars</a></li>
<li><a href="dr9/algorithms/target_selection.php#ROSAT">ROSAT All-Sky Survey Sources</a></li>
<li><a href="dr9/algorithms/target_selection.php#serendip">Serendipity targets</a></li>
<li><a href="dr9/algorithms/target_selection.php#references">References</a></li>
</ul>
...
<a href="dr9/algorithms/classify.php#photo_class">star-galaxy separation</a> cut used by Photo (galaxies targeted off
...
<a href="dr9/algorithms/flags_detail.php">the descriptions of flags</a>.
The
<a href="dr9/algorithms/magnitudes.php#mag_petro">Petrosian</a>
...
href="dr9/algorithms/classify.php#photo_sb"> Petrosian half-light
...
href="dr9/algorithms/magnitudes.php#mag_fiber"> fiber magnitudes</a>
...
<p><a href="dr9/algorithms/target_selection.php#Top">[Back to top]</a></p>
...
<a href="dr9/algorithms/magnitudes.php#mag_model">
...
(see <a href="dr9/algorithms/flags_detail.php">flag descriptions</a>)
...
target selection paper (<a href="dr9/algorithms/target_selection.php#references">referenced
below</a>).</p>
...
using <a href="dr9/algorithms/magnitudes.php#mag_psf"> PSF
...
href="dr9/algorithms/flags_detail.php">flag
...
href="dr9/algorithms/tiling.php">tiled</a>.</p>
...
<li> brown dwarfs (STAR_BROWN_DWARF) - this is the only <a
    href="dr9/algorithms/tiling.php">tiled</a> sample of stars</li>
...
<li> central stars of planetary nebulae (STAR_PN)</li>
     ...
     <p>For more information on these, please see <a href="dr9/algorithms/segue_target_selection.php#Legacy">
