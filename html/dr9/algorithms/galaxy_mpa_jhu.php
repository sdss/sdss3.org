<?php include '../../header.php'; echo head('Galaxy Properties from the MPA-JHU Group'); ?>

<h2 id="PCA">Galspec</h2>
...
href="dr9/spectro/spectro_access.php">described on the spectroscopic
data access page</a>.  The "galSpec" analyses have not been performed on the SDSS-III DR9 spectra.</p>
