...
<p>The <a href="dr9/software/idlutils.php">idlutils</a> package
...
<ul>
<li><a
href="dr9/software/idlutils_doc.php#MUNU_TO_RADEC">munu_to_radec</a>:
convert from Great Circle coordinates to Celestial coordinates</li>
<li><a
href="dr9/software/idlutils_doc.php#RADEC_TO_MUNU">radec_to_munu</a>:
convert from Celestial coordinates to Great Circle coordinates</li>
<li><a
href="dr9/software/idlutils_doc.php#ETALAMBDA_TO_RADEC">etalambda_to_radec</a>:
convert from survey coordinates to Celestial coordinates</li>
<li><a
href="dr9/software/idlutils_doc.php#RADEC_TO_ETALAMBDA">radec_to_etalambda</a>:
convert from Celestial coordinates to survey coordinates</li>
<li><a
href="dr9/software/idlutils_doc.php#STRIPE_TO_INCL">stripe_to_incl</a>:
return the inclination associated with a given stripe number</li>
<li><a
href="dr9/software/idlutils_doc.php#STRIPE_TO_ETA">stripe_to_eta</a>:
return the eta value along the middle of a Great Circle stripe number</li>
<li><a
href="dr9/software/idlutils_doc.php#ETA_TO_STRIPE">eta_to_stripe</a>:
return the closest stripe center to a given eta value</li>
<li><a
href="dr9/software/idlutils_doc.php#CSURVEY2EQ">csurvey2eq</a>:
convert from survey coordinates to Celestial coordinates</li>
<li><a
href="dr9/software/idlutils_doc.php#EQ2CSURVEY">eq2csurvey</a>:
convert from Celestial coordinates to survey coordinates</li>
</ul>
