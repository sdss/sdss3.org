...
<a href="dr9/algorithms/bitmasks.php">bitmask</a> called
<a href="dr9/algorithms/bitmask_resolve_status.php">resolve_status</a> (in the
flat files) or <a
href="dr9/algorithms/bitmask_resolve_status.php">resolveStatus</a>
...
the basis of the <a
href="dr9/algorithms/bitmask_flags1.php">objc_flags</a> bitmask as
follows:</p>
...
number called <a href="dr9/help/glossary.php#thingid"><code>thing_id</code></a>.  All
detections associated with that source have that same value of
<code><a href="dr9/help/glossary.php#thingid">thing_id</a></code>
...
In fact, <code><a href="dr9/help/glossary.php#thingid">thing_id</a></code> simply is equal to the zero-indexed row of thingIndex
...
listed the <a href="dr9/help/glossary.php#run"><code>RUN</code></a>, <a
href="dr9/help/glossary.php#run"><code>CAMCOL</code></a>, <a
href="dr9/help/glossary.php#run"><code>FIELD</code></a>, and <a
href="dr9/help/glossary.php#run"><code>ID</code></a> of all of the detections.</p>
...
href="dr9/help/glossary.php#thingid">thingID</a>. Thus, with known <a
href="dr9/help/glossary.php#thingid">thingId</a>s, one can join to all the
...
data, we have chosen one <a href="dr9/help/glossary.php#field">field</a> covering it as primary.  Over about
...
href="dr9/software/idlutils.php">idlutils</a> users can read it in
with <a
href="dr9/software/idlutils_doc.php#READ_FITS_POLYGONS">read_fits_polygons</a>. It
contains a set of polygons; the parameter "IFIELD" is an index into
the <a
href="http://data.sdss3.org/datamodel/files/PHOTO_RESOLVE/window_flist.html">window_flist.fits</a>
file that indicates which <a href="dr9/help/glossary.php#field">field</a> is primary in that polygon.
</p>

<p>The SAS front-end also provides <a href="http://data.sdss3.org/coverageCheck/">an interface to the same
information</a>, allowing the user to check the primary <a href="dr9/help/glossary.php#field">field</a> covering a
...
give an <a
href="http://skyserver.sdss3.org/dr9/en/help/docs/realquery.asp#footprint">example
...
<a href="dr9/help/glossary.php#run">run</a>s, ranging from an hour to over
...
long, narrow <a href="dr9/help/glossary.php#camcol">camcol</a>s on the sky,
...
into individual <a href="dr9/help/glossary.php#field">field</a>s that 9.8
...
href="dr9/algorithms/bitmask_image_status.php">image_status</a></code> doesn't
...
href="dr9/algorithms/bitmask_image_status.php">image_status</a></code>
...
using <code><a
href="dr9/algorithms/bitmask_resolve_status.php">resolve_status</a></code>; and</li>
...
<code><a
href="dr9/algorithms/bitmask_resolve_status.php">resolve_status</a></code>.</li>
</ol>
...
listing the <code><a href="dr9/help/glossary.php#thingid">thing_id</a></code> of its primary if appropriate. <a
href="http://data.sdss3.org/datamodel/files/PHOTO_RESOLVE/thingIndex.html">thingIndex</a>
