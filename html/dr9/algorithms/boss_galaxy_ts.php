...
<a href="dr9/algorithms/magnitudes.php#mag_model">model</a> magnitudes,
and magnitude cuts are applied on
<a href="dr9/algorithms/magnitudes.php#cmodel">cmodel</a> magnitudes.
...
file supplied in the <a href="dr9/tutorials/lss_galaxy.php">LSS Galaxy Catalogue cookbook</a>.</li> -->
...
<a href="dr9/algorithms/target_selection.php#lrg"> SDSS-I/II Cut-I </a>
...
<p> and <var>r</var><sub>psf</sub> is the <a href="dr9/algorithms/magnitudes.php#mag_psf">PSF</a> magnitude. </p>
...
algorithms used to target <a href="dr9/algorithms/target_selection.php#lrg">SDSS-I/II Cut-II </a>
...
<p> and <var>i</var><sub>fib2</sub> is the <a href="dr9/algorithms/magnitudes.php#mag_fiber">fiber</a> magnitude. </p>
...
<a href="dr9/spectro/caveats.php#Boss">spectro caveats page</a>.</p>
...
<a href="dr9/tutorials/lss_galaxy.php">LSS Galaxy Catalogue cookbook</a>.
Note that the LSS CMASS galaxy catalogue takes all of these issues into
account, and contains a uniform sample of CMASS galaxies. </p> -->
...
further details please see the <a href="dr9/spectro/caveats.php#Boss">spectro caveats page</a></p>
