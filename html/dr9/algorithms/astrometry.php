...
<ul>
<li><a href="dr9/algorithms/astrometry.php#intro">Introduction</a></li>
<li><a href="dr9/algorithms/astrometry.php#propermotions">Proper
Motions</a></li>
<li><a href="dr9/algorithms/astrometry.php#errors">Calculating errors for individual objects</a></li>
<li><a href="dr9/algorithms/astrometry.php#eqn">Calibration equations</a></li>
<li><a href="dr9/algorithms/astrometry.php#gcToEq">Transformation from Great Circle Coordinates to J2000 Celestial Coordinates</a></li>
<li><a href="dr9/algorithms/astrometry.php#astromqa">QA files</a></li>
<li><a
href="dr9/algorithms/astrometry.php#caveats">Caveats on
DR8 astrometry</a></li>
</ul>
...
<p><a href="dr9/algorithms/astrometry.php#Top">[Back to top]</a></p>
...
href="http://data.sdss3.org/sas/dr9/boss/photoObj/external/PM">"PM"
external catalogs directory</a> in SAS. </p>

<p>The proper motions in DR9 correct an error in DR7 proper motions
for stars at low Galactic latitude; see the <a
href="dr9/algorithms/astrometry.php#astromqa">QA discussion below</a>
for more details. </p>
...
contains for each field in DR9 an estimate of the DR9 position offset
...
<li> <p>There is a <a
href="http://data.sdss3.org/sas/dr9/boss/photoObj/astromqa/astromqa-1500-750.html">global
...
properly.  On the right side of the top row are the DR9 proper motions
...
illustrate the differences between the DR9 astrometry and the UCAC2
...
for the proper motions. We believe that the DR9 proper motions are 
superior in these areas.</p>

<p>Finally, the proper motions values in DR9 have been checked for
...
href="http://data.sdss3.org/sas/dr9/boss/photoObj/astromqa/astromqa-1500-750.html">astrometry
...
href="http://data.sdss3.org/sas/dr9/boss/photoObj/astromqa/plots/301/752/">run
...
using the DR9 astrometry and proper motions, which are available in
the DR9 release, or in the <code>astromDR9</code> and
<code>properMotionsDR9</code> tables of the DR8 CAS.</p>
...
href="dr9/algorithms/astrometry.php#propermotions">proper motions</a>
...
<p>The astrometry errors that appeared in DR8 have been corrected in DR9. 
Therefore, many objects will have slightly different positions in DR9 
than they did in DR8. This will in turn change the IAU identifiers (SDSSJ...) 
of those objects. However, all <a href="dr9/help/glossary.php#ObjID">SDSS object 
IDs</a> are unchanged between DR8 and DR9, so it is always possible to obtain 
an exact match for any object between DR8 and DR9.</p>
