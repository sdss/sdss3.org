...
href="http://skyserver.sdss3.org/dr9/">SkyServer</a> to find all
...
<a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL</a>.</p>
...
<ul>
    <li><a href="dr9/tutorials/getdata.php#iqs">Using the Imaging Query Form</a></li>
    <li><a href="dr9/tutorials/getdata.php#radec">Find by Position</a></li>
    <li><a href="dr9/tutorials/getdata.php#magcolor">Find by Magnitude or Color</a></li>
    <li><a href="dr9/tutorials/getdata.php#absmag">Find by Absolute Magnitude</a></li>
</ul>

<h3 id="iqs">Using the <a href="http://skyserver.sdss3.org/dr9/en/tools/search/iqs.asp">Imaging Query Form</a></h3>
...
<ol>
  ...
  <li>You can use the <b>Filters</b> checkboxes to choose which filter names to return. The Imaging Query Form
         ...
         query to the <a href="http://dr9.sdss3.org">SDSS-III Science Archive Server (SAS)</a>.</li>
</ol>
...
<h3 id="radec">Find by <a href="http://skyserver.sdss3.org/dr9/en/tools/search/iqs.asp">Position</a></h3>
...
<h3 id="magcolor">Find by <a href="http://skyserver.sdss3.org/dr9/en/tools/search/iqs.asp">Magnitude or Color</a></h3>
...
<ol>
  ...
  <li>You can also search for the presence or absence of specific <em>flags</em>. See the tutorial <a href="dr9/tutorials/flags.php">Find out if SDSS's imaging data for an object are reliable?</a>
...
<h3 id="absmag">Find by <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">Absolute Magnitude</a></h3>
...
<p>Unfortunately, the Imaging Query Form allows you to search only by apparent magnitude, which is what is observed and stored in the
   database. To find objects by absolute magnitude, you will need to perform a <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">
   SQL search</a>.</p>
