...
<ul>
<li><a href="dr9/tutorials/segue_getting_started.php#survey_design">Survey Design</a></li>
<li><a href="dr9/tutorials/segue_getting_started.php#segue1_vs_segue2">Differences between SEGUE-1 and SEGUE-2</a>
    <ul>
        <li><a href="dr9/tutorials/segue_getting_started.php#spatial">Spatial Coverage</a></li>
        <li><a href="dr9/tutorials/segue_getting_started.php#s1s2_tselec">Target Selection</a></li>
    </ul>
</li>
<li><a href="dr9/tutorials/segue_getting_started.php#dr9_new">New in Data Release 9!</a></li>
<li><a href="dr9/tutorials/segue_getting_started.php#segue_data">SEGUE Data</a>
    <ul>
       <li><a href="dr9/tutorials/segue_getting_started.php#data_processing">Data Processing</a></li>
	<li><a href="dr9/tutorials/segue_getting_started.php#sspp">SEGUE Stellar Parameter Pipeline (SSPP)</a></li>
       <li><a href="dr9/tutorials/segue_getting_started.php#added_value">SEGUE Value-Added Catalogs</a></li>
</ul>
</li>
<li><a href="dr9/tutorials/segue_getting_started.php#extract_segue_data">Extracting Different Types of SEGUE Data</a>
    <ul>
       <li><a href="dr9/tutorials/segue_getting_started.php#extract_spec">Extracting SEGUE Spectra</a></li>
      <li><a href="dr9/tutorials/segue_getting_started.php#extract_image">Extracting SDSS Images of SEGUE Targets</a></li>
       <li><a href="dr9/tutorials/segue_getting_started.php#extract_param">Extracting Stellar Properties from SEGUE</a></li>
       <li><a href="dr9/tutorials/segue_getting_started.php#warnings">Warnings</a></li>
    </ul>
</li>
<li><a href="dr9/tutorials/segue_getting_started.php#seg_science">SEGUE Science Results</a></li>
</ul>
...
href="dr9/spectro/spectro_basics.php#identifying">plate</a>." The
...
href="dr9/algorithms/segue_target_selection.php">SEGUE Target
...
href="dr9/algorithms/segue_plate_table.php">SEGUE Plates</a> page.</p>
...
href="dr9/algorithms/segue_target_selection.php#SEGUEts1">15 different
...
SEGUE-2 samples <a
href="dr9/algorithms/segue_target_selection.php#SEGUEts2">9 different
...
<h2 id="dr9_new">New in Data Release 9!</h2>

<p><a href="dr9/whatsnew.php">What's New in DR9?</a> provides information about all of the new data
products in SDSS-III Data Release 9 (DR9). For the SEGUE survey, the <a
href="dr9/spectro/sspp_changes.php">SSPP has been improved and
recalibrated</a>. This updated pipeline has been run on all SDSS,
SEGUE-1, and SEGUE-2 stellar spectra. The DR9 version of the SEGUE
data also determines the different stellar categories each photometric
and spectroscopic stellar observation belongs to using updated DR9
photometry and <a href="dr9/whatsnew.php#astrometry">astrometry</a>
(these are recorded as <a
href="dr9/algorithms/segue_bit_guide.php">bitmasks</a> in the <a
href="http://skyserver.sdss3.org/dr9/en/help/browser/description.asp?n=segueTargetAll&amp;t=U">segueTargetAll</a>
table). </p>

<p>DR9 SEGUE includes three new <a
href="dr9/tutorials/segue_getting_started.php#added_value">value-added
tables</a>. These include new parameter estimates from the SSPP, a list of
duplicate spectra useful for testing, and a catalog to create a complete and
unbiased sample of G- and K-dwarf stars. </p>
...
with the <a href="dr9/spectro/pipeline.php">SDSS spectroscopic
pipeline</a>. These stellar spectra range from 3850 to 9200&#197; in
<a href="dr9/spectro/spectro_basics.php#vacuum">vacuum
wavelengths</a>.  </p>
...
<a href="dr9/imaging/pipeline.php">Imaging Pipeline</a> page.  As part
of this pipeline, each photometric object is <a
href="dr9/algorithms/classify.php#photo_class">classified as either a
star or galaxy</a>. Additionally, each individual spectra is <a
href="dr9/algorithms/match.php">position-matched in RA and Dec</a>
with the photometric catalog. </p>


<h3 id="sspp">SEGUE Stellar Parameter Pipeline (SSPP)</h3>

<p> After the <a href="dr9/spectro/pipeline.php">SDSS spectroscopic
pipeline</a> has reduced and calibrated the SEGUE and SDSS Legacy
stellar spectra, each one is processed by the <a
href="dr9/spectro/sspp.php">SEGUE Stellar Parameter Pipeline</a>,
...
href="dr9/spectro/sspp_changes.php">improved considerably since
...
href="dr9/spectro/alpha_catalog.php">[&alpha;/Fe] value-added
catalog</a>. </p>
...
<a href="dr9/spectro/duplicates.php">Duplicate Spectra</a> provides a
list of all of the repeat spectroscopic observations of a single
photometric target.  Second, DR9 provides <a
href="dr9/algorithms/segue_target_selection_weights.php">various weights for
...
href="dr9/data_access/">access this data</a>. Experts can directly
access the <a href="http://data.sdss3.org/sas/dr9/">DR9 data
...
spectroscopic information, please use the <a href="dr9/spectro">SDSS
Spectroscopic Data</a> and <a
href="dr9/tutorials/gettingstarted.php#segue2">Getting the Data</a>
pages.</p>

<p>If you just want a quick look at the spectrum for an individual
target, use the <a href="http://dr9.sdss3.org/basicSpectra">DR9
...
the <a href="http://dr9.sdss3.org/bulkSpectra">bulk version</a> of the DR9 SAS.
...
<p> If you know which rerun your plate is in, you may go to the SAS
 ...
 href="http://data.sdss3.org/sas/dr9/sdss/spectro/redux/">here</a>,
 ...
 href="dr9/data_access/bulk.php">Bulk Data Download</a>. More
 information is available in the section on <a
 href="dr9/tutorials/gettingstarted.php">Downloading the Data</a>.</p>
...
<p>There are various tools available to extract SDSS images for SEGUE targets.
 You can create a <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/chart.asp">Finding Chart</a>, or extract images for up to 1000 objects using
 the <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Image List Tool</a>. If your needs are more complex than this, please use the <a href="dr9/imaging">Imaging Data</a>. </p>
...
href="http://skyserver.sdss3.org/dr9/en/">SDSS-III SkyServer</a>. If
...
CasJobs</a>. Using the SQL language, this allows
...
using the <a
href="http://skyserver.sdss3.org/dr9/en/help/howto/search/">SkyServer
SQL Tutorial</a>, <a
href="http://skyserver.sdss3.org/dr9/en/help/docs/realquery.asp">Sample
SQL Queries</a>, and, most importantly, the <a
href="dr9/tutorials/segue_sqlcookbook.php">Using
...
href="dr9/imaging/caveats.php">photometric</a> and <a
href="dr9/spectro/caveats.php">spectroscopic</a> caveats.</p>

<p>There are a number of methods you can use to ensure quality
data. The SSPP provides various <a href="dr9/spectro/sspp_flags.php">
warning flags</a> for its stellar parameter estimates.  In addition,
the <a href="dr9/tutorials/segue_sqlcookbook.php#Quality">SEGUE SQL
...
<h2 id="seg_science">SEGUE Science Results</h2>

<p>There have been over 90 papers published with
SEGUE data. Many of these are listed on
 the <a href="science/segue_publications.php">SEGUE Publications</a>
page. </p>

<p>Below we list the different SEGUE Background papers,
presenting a summary of the different surveys and the SSPP.</p>
...
<li>The SEGUE Stellar Parameter Pipeline
    <ul>
        ...
        <li><a href="http://adsabs.harvard.edu/abs/2010arXiv1008.1959S">Paper IV. Validation with an Extended Sample of Galactic Globular and Open Clusters </a></li>
        <li><a href="http://adsabs.harvard.edu/abs/2010arXiv1010.2934L">Paper V. Estimation of Alpha-Element Abundance Ratios from Low-Resolution SDSS/SEGUE Stellar Spectra</a></li>
    </ul>
</li>
</ul>
