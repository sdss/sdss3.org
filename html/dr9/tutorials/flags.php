...
<p>The SDSS does automatic processing to determine the reliability of the imaging data
   ...
   SDSS's <a href="http://skyserver.sdss3.org/dr9/">SkyServer</a>; the flags are stored in the PhotoObj table in the CAS database. Understanding the
...
href="dr9/algorithms/photo_flags_recommend.php">more detailed
...
<p>By using several flags together, you can search for only objects that have clean photometry.
   (<a href="dr9/tutorials/flags.php#clean">skip to clean photometry search guide)</a></p>

<p>Flags are yes/no parameters (see the <a href="dr9/algorithms/bitmasks.php">bitmask</a> page). If a certain flag (such as <i>Saturated</i>) is present for an object,
...
<p>You can view flag names directly with the <a
   href="http://skyserver.sdss3.org/dr9/en/tools/explore/obj.asp">
...
<h2>Jump to</h2>
<ul>
    <li><a href="dr9/tutorials/flags.php#single">Flags for a single object</a></li>
    <li><a href="dr9/tutorials/flags.php#interpret">Interpret Flags</a></li>
    <li><a href="dr9/tutorials/flags.php#query">Flags in a Query</a></li>
    <li><a href="dr9/tutorials/flags.php#sql">Flags with SQL</a></li>
    <li><a href="dr9/tutorials/flags.php#clean">Clean Photometry</a></li>
    <li><a href="dr9/tutorials/flags.php#cleanflag">A Shortcut: the "clean" flag</a></li>
</ul>
...
<li>Use the <a href="http://skyserver.sdss3.org/dr9/en/tools/explore/obj.asp">Explore</a> tool
to look at a single object. See the <a href="dr9/tutorials/getimage.php">How do I get an image of my favorite object?</a> tutorial to learn how to use the Explore tool.</li>
...
<li>Look at <b>flags</b>, the third row of data just below the object's coordinates. You will see the
       ...
       <a href="http://skyserver.sdss3.org/dr9/en/help/browser/browser.asp">Schema Browser</a> for what they mean. Instructions
       for using the Schema Browser are in the next section, <a href="dr9/tutorials/flags.php#interpret">Interpret Flags</a>.</li>
...
<li>Use the <a href="http://skyserver.sdss3.org/dr9/en/help/browser/browser.asp">Schema Browser</a>
...
<img src="images/info.gif" alt="info button" /> link to the right of <b>flags</b>. </li>
...
<p>You can search through flags as part of your searches with the <a href="http://skyserver.sdss3.org/dr9/en/tools/search/iqs.asp">Imaging
...
<li>Go to the <a href="http://skyserver.sdss3.org/dr9/en/tools/search/iqs.asp">Imaging Query Form</a>. From the astronomers'
       main page, look under <b>Search Tools</b>. For more on how to use the Imaging Query Form, see the guide
       <a href="dr9/tutorials/getdata.php">How do I find data for all objects in a given RA/Dec/Magnitude/Absolute Magnitude
       range?</a></li>
...
<li>Go to the <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL Search</a> tool, under the
...
<p>The queries below run slowly. These are test versions that use <b>TOP 10</b> to return only the first 10
   matching objects. To return all matching objects, remove the top 10 and use the <a href="http://skyserver.sdss3.org/CasJobs/">CasJobs</a>
...
href="http://skyserver.sdss3.org/dr9/en/help/docs/realquery.asp#cleanStars"> this one </a> and  <a href="http://skyserver.sdss3.org/dr9/en/help/docs/realquery.asp#cleanGals"> this one </a></p>.
...
href="dr9/algorithms/photo_flags_recommend.php">recommended flags
