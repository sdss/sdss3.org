...
magnitude, color, or absolute magnitude. The guide <a href="dr9/tutorials/getdata.php">How do I find data for all objects
...
spectra, you will use the <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Image List</a> tool along
with <a href="http://skyserver.sdss3.org/dr9/en/help/howto/search">SQL</a>.</p>
...
<h2>Jump to:</h2>
<ul>
    <li><a href="dr9/tutorials/searchimage.php#imagelist">Using the Image List tool</a></li>
    <li><a href="dr9/tutorials/searchimage.php#query">Submit a Query to Image List</a></li>
    <li><a href="dr9/tutorials/searchimage.php#view">View Your Search Results</a></li>
</ul>


<h3 id="imagelist">Using the <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Image List tool</a></h3>

<ol>

  <li><p>Go to the <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Image List tool</a>.
...
<h3 id="query">Submit a Query to <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Image List</a></h3>
...
<h3 id="view">View Your <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Search Results</a></h3>

<ol>

  <li><p>Click on the thumbnail image to go to the <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/navi.asp">Navigate</a> tool
  ...
  to the <a href="http://skyserver.sdss3.org/dr9/en/tools/explore/obj.asp">Explore</a>
