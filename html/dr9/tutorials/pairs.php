...
in SDSS data with an <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL Search</a>
...
<p>To learn more about SQL, see SkyServer's <a href="http://skyserver.sdss3.org/dr9/en/help/howto/search">SQL Tutorial</a>
and guide to <a href="http://skyserver.sdss3.org/dr9/en/help/docs/sql_help.asp">Using SQL with SkyServer</a>.</p>

<ol>

<li><p>In the large textbox of the <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL Search</a> tool,
...
<a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">Image List</a> tool. From
the astronomers' main page, look under <i>Advanced Tools</i>. From the public main page, look under
<i>SkyServer Tools</i>.</li>

</ol>

<h3>View <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/list.asp">thumbnails</a></h3>
...
results you will probably need to use <a href="http://skyserver.sdss3.org/casjobs">CasJobs</a>.
See the <a href="http://skyserver.sdss3.org/casjobs/guide.aspx">CasJobs help pages</a> for more information.</li>
