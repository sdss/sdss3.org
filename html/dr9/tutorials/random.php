...
href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL Search</a>.
To learn more about SQL, see SkyServer's <a href="http://skyserver.sdss3.org/dr9/en/help/howto/search">SQL Tutorial</a>
and guide to <a href="http://skyserver.sdss3.org/dr9/en/help/docs/sql_help.asp">Using SQL with SkyServer</a>.</p>

<ol>

<li>Go to the <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL Search</a> page.
