...
<p>The SDSS <a href="http://skyserver.sdss3.org/dr9/">SkyServer</a> has images, spectra, and catalog data for
...
<ol>
  <li>Go to the CAS's <a href="http://skyserver.sdss3.org/dr9/en/tools/chart/navi.asp">Navigate</a>
  ...
  <li>Look at the <b>ra</b> and <b>dec</b> input boxes near the top left of the tool. Enter the coordinates
         ...
         use the format "hh:mm:ss &plusmn;dd:mm:ss", and be sure to include seconds even if they are 00. (You may have to
        ...
        <table class="noborder" style="width:100%;">
               ...
               <tr>
                  ...
                  <td style="width:80%">Draw a small yellow cross-hair around each object
                                                             <a href="dr9/help/glossary.php#target">targeted</a>
                                                             for spectroscopy</td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td style="width:80%">Draw the outline of each imaging
                    <a href="dr9/help/glossary.php#field">field</a>
                  (in gray)</td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <a href="dr9/help/glossary.php#plate">plate</a> (in pink)</td>
               </tr>
               <tr>
...
<ol>
  ...
  <li>Click the <b>Explore</b> link in the right panel of the Navigate tool to go to the
         <a href="http://skyserver.sdss3.org/dr9/en/tools/explore/obj.asp">Explore</a> tool.
