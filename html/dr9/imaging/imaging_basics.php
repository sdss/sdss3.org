...
<p>The fundamental units of SDSS images are <a href="dr9/help/glossary.php#field">fields</a>
...
<ul>
<li> the <a href="dr9/help/glossary.php#run">run</a> number, which
identifies the specific scan,</li>
<li> the <a href="dr9/help/glossary.php#camcol">camera
column</a>, or "camcol," a number from 1 to 6, identifying the scanline within the run,
and</li>
<li> the <a href="dr9/help/glossary.php#field">field number</a>.  The
...
href="http://dr9.sdss3.org/fields/runCamcolField?run=3704&amp;camcol=3&amp;field=91&amp;submit=Submit">DR9
Science Archive Server Imaging Fields search</a> will create links to
...
<a href="dr9/help/glossary.php#run">run</a> and there is a unique integer identifying
...
<a href="dr9/help/glossary.php#camcol">camcols</a>, and are numbered 1
...
<a href="dr9/help/glossary.php#field">fields</a>, each 1489 pixels
...
analysis input into the <a href="dr9/imaging/pipeline.php">SDSS
imaging pipeline</a>.
...
<a href="http://skyserver.sdss3.org/dr9">SkyServer</a> and
<a href="http://skyservice.pha.jhu.edu/casjobs/">CasJobs</a>, all imaging parameters
...
<a href="http://data.sdss3.org">DR9 Science Archive Server</a>, the bandpasses are
...
<a href="dr9/imaging/pipeline.php">Imaging Pipeline</a> and
<a href="dr9/algorithms/">Algorithms</a> pages. The result is a set of
...
64-bit integer called <a href="dr9/help/glossary.php#ObjID">ObjID</a>.
...
href="dr9/help/glossary.php#parent">parent</a> objects.  The image to
...
href="dr9/help/glossary.php#deblend">deblending</a> breaks each parent
...
<a href="dr9/help/glossary.php#parent">child</a> objects.  For nearly
...
href="dr9/help/glossary.php#resolve">resolve</a> procedure determines
the "best" observation of every object, which it identifies as the <a
href="dr9/help/glossary.php#primary">primary</a> object. The
documentation on the <a href="dr9/algorithms/resolve.php">Resolve
...
href="dr9/algorithms/bitmask_resolve_status.php">resolve_status</a></code>
...
href="dr9/algorithms/bitmask_flags1.php">FLAGS1</a> and <a
href="dr9/algorithms/bitmask_flags2.php">FLAGS2</a> (in CAS and
...
href="dr9/algorithms/bitmasks.php">bitmasks</a>. To learn how to use
them to find reliable imaging, see the <a
href="dr9/tutorials/flags.php">Clean Photometry</a> tutorial and look
at our <a href="dr9/algorithms/photo_flags_recommend.php">photometric
