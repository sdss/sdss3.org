...
<div class="summary">
	...
	caveats in SDSS Data Release 9 imaging data.</p>
</div>

<h2>List of caveats</h2>

<ol>
<li><a href="dr9/imaging/caveats.php#astrometry">Astrometry errors: FIXED IN DR9!</a></li>
<li><a href="dr9/imaging/caveats.php#skylev">Sky levels sometimes overestimated</a></li>
<li><a href="dr9/imaging/caveats.php#objid">Changes in SDSS object IDs</a></li>
<li><a href="dr9/imaging/caveats.php#timeout">Field timeouts</a></li>
<li><a href="dr9/imaging/caveats.php#flags2">Missing flag bits: FIXED!</a></li>
<li><a href="dr9/imaging/caveats.php#badcol">Bad CCD columns</a></li>
<li><a href="dr9/imaging/caveats.php#redleak">Very red objects</a></li>
<li><a href="dr9/imaging/caveats.php#usky">Bias in u-band sky</a></li>
<li><a href="dr9/imaging/caveats.php#highpmstars">Missing high-proper-motion stars</a></li>
<li><a href="dr9/imaging/caveats.php#cav_lowlat">Photometry at lower galactic latitudes</a></li>
<li><a href="dr9/imaging/caveats.php#sectors">Missing survey geometry</a></li>
<li><a href="dr9/imaging/caveats.php#responselimit">SkyServer returns "response buffer limit exceeded"</a></li>
<li><a href="dr9/imaging/caveats.php#missingoutlines">Missing outlines in some runs</a></li>
</ol>
...
irrelevant for DR9 and subsequent releases. The DR9 astrometry and
...
<p>SDSS Object IDs have not changed as a result as a the improved astrometry, although the IAU identifiers (SDSSJ...) may have changed.</p>

<p><a href="dr9/imaging/caveats.php#Top">Back to top</a></p>
...
<tr><td>Differences between the true and measured sizes
 ...
 href="dr9/algorithms/magnitudes.php#cmodel">cmodel</a>
...
The <a href="dr9/help/glossary.php#ObjID"><code>objID</code></a>
...
<p>Second, the <a href="dr9/algorithms/resolve.php">resolve</a>
...
href="dr9/algorithms/image_quality.php">image quality documentation</a>
...
href="http://data.sdss3.org/sas/dr9/boss/photo/redux/301/1740/objcs/1/">http://data.sdss3.org/sas/dr9/boss/photo/redux/301/1740/objcs/1/</a>.
They can be read with the <code>read_mask</code> command; see our
description of <a href="dr9/imaging/images.php#atlas">reading atlas
...
href="http://skyserver.sdss3.org/dr9/en/help/browser/description.asp?n=ProperMotions&amp;t=U">ProperMotions
...
whatsoever. Using the <a href="dr9/algorithms/image_quality.php">image
...
<a href="http://skyserver.sdss3.org/dr9/en/help/browser/browser.asp?n=sdssSector&t=U">Sectors</a>
and
<a href="http://skyserver.sdss3.org/dr9/en/help/browser/browser.asp?n=fFootprintEq&t=F">Footprints</a>,
will be created shortly. We are also developing a new Geometry viewer, which will
allow interactive inspection of the different survey boundaries.</p>
...
<h2 id="missingoutlines">Missing outlines in some runs</h2>

<p>Some fields in DR9 imaging are missing object outlines. Thus, in these fields, the
<span class="term">Outlines</span> option in the SkyServer
<a href="http://skyserver.sdss3.org/dr9/en/tools/chart/navi.asp">Navigate</a> tool does not work.
The table below shows run-camcol combinations that do not have outlines, or have
partial outlines only.</p>

<table class="common">
 <tr>
  <th>Run</th>
  <th>No outlines</th>
  <th>Partial outlines</th>
 </tr>
 <tr>
  <td>1462</td>
  <td>3-6</td>
