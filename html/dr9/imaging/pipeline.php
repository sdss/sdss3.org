...
<p>This page describes the SDSS imaging pipeline, which processes the raw telescope
imaging to produce calibrated FITS files and catalogs of imaging parameters. Each
step in the pipeline is outlined below.</p>

<p>More detail is available in the <a href="dr9/algorithms">Algorithms</a>
section of this site. The <a href="http://adsabs.harvard.edu/abs/2002AJ....123..485S">Early
...
products. Successive data release papers describe changes between data
releases - see <a href="science/dr_publications.php">SDSS Data Release Publications</a> for
a complete list, with links.
The Data Release 9 paper describes some changes to astrometry algorithms that have occurred
with DR9.
<!--
The Data Release 9 paper
<span class="todo">(TODO: Wood-Vasey: put up PDF of the DR9 paper and link to it
from here)</span> describes some changes to astrometry algorithms that have occurred
with DR9.
-->
</p>

<p>In addition to these data release papers, the
<a href="http://adsabs.harvard.edu/abs/2000AJ....120.1579Y">SDSS technical
...
1997. The <a href="http://data.sdss3.org/datamodel/index-files.html">SAS
...
each detail section provides references to papers that give additional
...
<ul>
<li><a href="dr9/imaging/pipeline.php#imobs"><b>Imaging Observing</b></a><br />
...
<li><a href="dr9/imaging/pipeline.php#imred"><b>Imaging Data Reduction</b></a><br />
...
<li><a href="dr9/imaging/pipeline.php#resolve"><b>Resolution of Multiple Detections</b></a><br />
...
-->
<li><a href="dr9/imaging/pipeline.php#ubercal"><b>Recalibration</b></a><br />
...
calibrations.</li>
<li><a href="dr9/imaging/pipeline.php#catalogs"><b>Final Photometric Catalog</b></a><br />
...
along a great circle. The data acquisition system divided the
...
<td>boss/photo/redux/%d/%d/logs/idReport-%05d.par</td>
<td>rerun, run, mjd</td>
</tr>
<tr>
...
<td>boss/photo/data/%d/fields/%d/idR-%06d-%s%d-%04d.fit.Z</td>
...
<td>boss/photo/data/%d/gangs/idGang-%06d-%s%d-%04d.fit</td>
...
<td>boss/photo/redux/%d/%d/logs/idFrameLog-%06d-%d.par</td>
...
<td>boss/photo/redux/%d/%d/logs/opCamera-%05d.par</td>
...
<td>boss/photo/redux/%d/%d/logs/opConfig-%05d.par</td>
<td>rerun, run, mjd (of generation)</td>
</tr>
<tr>
...
<td>boss/photo/redux/%d/%d/logs/opECalib-%05d.par</td>
<td>rerun, run, mjd (of generation)</td>
</tr>
</table>
...
<td>boss/photo/redux/%d/%d/logs/idWeather-%05d.par</td>
<td>rerun, run, mjd</td>
</tr>
</table>
...
<td>boss/photo/redux/%d/%d/ssc/scPlan.par</td>
<td>run, rerun</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/datamodel/files/PHOTO_REDUX/RERUN/RUN/logs/idReport.html">idReport</a></td>
...
<td>boss/photo/redux/%d/%d/log/opBC-%d.par</td>
...
<td>boss/photo/redux/%d/%d/ssc/koCat-%06d.fit</td>
<td>run, rerun, run</td>
</tr>
</table>
...
<td>boss/photo/redux/%d/%d/photo/psParam.par</td>
<td>run, rerun</td>
</tr>
<tr>
...
<td>boss/photo/redux/%d/%d/photo/psPlan.par</td>
<td>run, rerun</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/datamodel/files/PHOTO_REDUX/RERUN/RUN/logs/opCamera.html">opCamera</a></td>
...
<td>in</td>
<td>bias vector</td>
<td>boss/photo/redux/%d/%d/photo/calib/idB-%06d-%c%d.fit</td>
...
the <a href="dr9/imaging/images.php#psf">extracting
PSF images</a> page) </td>
<td>boss/photo/redux/%d/%d/objcs/%d/psField-%06d-%d-%04d.fit</td>
...
<p>The astrometric pipeline calculates the astrometric solution. The <a href="dr9/algorithms/astrometry.php">astrometry</a>
...
<td>boss/photo/redux/%d/%d/astrom/asParam.par</td>
<td>rerun, run</td>
</tr>
<tr>
...
<td>boss/photo/redux/%d/%d/astrom/asPlan.par</td>
<td>rerun, run</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/datamodel/files/PHOTO_REDUX/RERUN/RUN/logs/opCamera.html">opCamera</a></td>
...
<td>out</td>
<td>transformation coefficients from row, column to great circle
coordinates</td>
<td>boss/photo/redux/%d/%d/astrom/asTrans-%06d.fit</td>
<td>rerun, run, run</td>
</tr>
</table>
...
<ul>
<li><a href="dr9/algorithms/magnitudes.php">Measures
of flux and magnitudes</a> describes the variety of methods
frames uses to measure the magnitude of each object,
including
<a href="dr9/algorithms/magnitudes.php#photo_profile">radial
profiles</a>,
<a href="dr9/algorithms/magnitudes.php#mag_fiber">fiber</a>,
<a href="dr9/algorithms/magnitudes.php#mag_model">model</a>,
<a href="dr9/algorithms/magnitudes.php#cmodel">cModel</a>,
<a href="dr9/algorithms/magnitudes.php#mag_petro">Petrosian</a> and
<a href="dr9/algorithms/magnitudes.php#mag_psf">PSF</a>
magnitudes and
<a href="dr9/algorithms/magnitudes.php#which_mags">when to use each</a>.</li>
<li><a href="dr9/algorithms/classify.php">Classification
and Morphology</a> describes other measurements of objects,
including
<a href="dr9/algorithms/classify.php#photo_class">star/galaxy separation</a>,
<a href="dr9/algorithms/classify.php#photo_fits">model fits</a>,
<a href="dr9/algorithms/classify.php#photo_sb">surface brightnesses</a>,
<a href="dr9/algorithms/classify.php#photo_stokes">ellipticities</a>,
<a href="dr9/algorithms/classify.php#photo_adaptive">adaptive
moments</a> and
<a href="dr9/algorithms/classify.php#photo_iso">isophotal quantities</a>.</li>
<li><span style="color:red;">IMPORTANT!</span> <a href="dr9/algorithms/photo_flags.php">Photometric
processing flags</a> describes the variety of flags frames
sets for each object, essential for properly interpreting
the catalog.</li>
<li><a href="dr9/algorithms/fluxcal.php#counts2mag">Flat
...
<li><a href="dr9/algorithms/sky.php">Sky measurement</a></li>
<li><a href="dr9/algorithms/deblend.php">Deblending</a>
...
<li><a href="dr9/algorithms/masks.php">Creation of imaging masks</a></li>
</ul>
...
<td>boss/photo/redux/%d/%d/photo/fpParam.par</td>
<td>rerun, run</td>
</tr>
<tr>
...
<td>boss/photo/redux/%d/%d/photo/fpPlan.par</td>
<td>rerun, run</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/datamodel/files/PHOTO_REDUX/RERUN/RUN/logs/idReport.html">idReport</a></td>
...
<td>boss/photo/redux/%d/%d/objcs/%d/fpFieldStat-%06d-%d-%04d.fit</td>
<td>rerun, run, camcol, run, camcol, field</td>
</tr>
<tr>
...
<td>boss/photo/redux/%d/%d/objcs/%d/fpObjc-%06d-%d-%04d.fit</td>
<td>rerun, run, camcol, run, camcol, field</td>
</tr>
<!--
<tr>
...
<td>boss/photo/redux/%d/%d/corr/%d/fpC-%06d-%c%d-%04d.fit</td>
...
<td>boss/photo/redux/%d/%d/objcs/%d/fpBIN-%06d-%c%d-%04d.fit.gz</td>
<td>rerun, run, camcol, run, filter, camcol, field</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/datamodel/files/PHOTO_REDUX/RERUN/RUN/objcs/CAMCOL/fpM.html">fpM</a></td>
<td>out</td>
<td>the frame masks (read using <a href="dr9/imaging/images.php#readAtlasImages">readAtlasImages</a>)</td>
<td>boss/photo/redux/%d/%d/objcs/%d/fpM-%06d-%c%d-%04d.fit.gz</td>
<td>rerun, run, camcol, run, filter, camcol, field</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/datamodel/files/PHOTO_REDUX/RERUN/RUN/objcs/CAMCOL/fpAtlas.html">fpAtlas</a></td>
<td>out</td>
<td>the atlas images for all objects detected (read using <a href="dr9/imaging/images.php#readAtlasImages">readAtlasImages</a>)</td>
<td>boss/photo/redux/%d/%d/objcs/%d/fpAtlas-%06d-%d-%04d.fit</td>
<td>rerun, run, camcol, run, camcol, field</td>
</tr>
</table>
...
calibration of a run, but now the <a href="dr9/imaging/pipeline.php#ubercal">"ubercal"
calibrations</a> supersede these "final" calibrations.</p>

<p>The <a href="dr9/algorithms/fluxcal.php">photometric
flux calibration algorithms page</a> describes the calibration
and use of calibrated quantities in more detail, and includes
sections on
<a href="dr9/algorithms/fluxcal.php#assessment">assessment of
photometric calibration</a>,
<a href="dr9/algorithms/fluxcal.php#counts2mag">converting SDSS counts to
SDSS (asinh) magnitudes</a> (and <em>vice versa</em>),
<a href="dr9/algorithms/fluxcal.php#SDSStoAB">converting SDSS to AB
magnitudes</a>, and
<a href="dr9/algorithms/fluxcal.php#SDSStoflux">converting SDSS
asinh magnitudes to fluxes.</a>
<a href="dr9/algorithms/sdssUBVRITransform.php">Another
...
calibrated catalogs contain a field declaring whether the specific observation
...
<td>boss/resolve/%s/%d/%d/resolve/%d/reObjGlobal-%06d-%d-%04d.fit</td>
...
<td>boss/resolve/%s/thingList.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/thingIndex.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/window_flist.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/window_unified.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/window_blist.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/window_bcaps.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/window_bindx.fits</td>
<td>resolve rerun</td>
</tr>
<tr>
...
<td>boss/resolve/%s/window_findx.fits</td>
<td>resolve rerun</td>
</tr>
</table>
...
the entire survey. See the <a href="dr9/algorithms/fluxcal.php">photometric
...
<td>boss/calib/%s/%d/%d/nfcalib/calibPhotomGlobal-%06d-%d.fits</td>
<td>calibration rerun, rerun, run, run, camcol</td>
</tr>
<tr>
<td><a href="http://data.sdss3.org/sas/dr9/boss/calib/dr8_final/plots/">calib</a></td>
<td>out</td>
<td>Uberal quality assurance plots</td>
<td>boss/calib/%s/plots/calib-%06d-%c-%s.png</td>
...
<td>boss/photoObj/%d/%d/%d/photoObj-%06d-%d-%04d.fits</td>
<td>rerun, run, camcol, run, camcol, field</td>
</tr>
<tr>
...
<td>boss/photoObj/%d/%d/photoField-%06d-%d.fits</td>
...
<td>boss/photoObj/photoRunAll-%s.fits</td>
<td>release (DR8)</td>
</tr>
</table>
