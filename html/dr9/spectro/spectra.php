...
<h1>NOTE: this page is out of date! Information from here has been spread out among the 
<a href="dr9/spectro/index.php">Spectroscopic data index page</a>, 
<a href="dr9/spectro/spectro_basics.php">Understanding SDSS spectroscopic data</a>, 
and <a href="dr9/spectro/spectro_access.php">Available spectroscopic data</a>. We're
keeping it here just for now to preserve existing links. If you've gotten to this page, fix 
the link that brought you here!</h1>

<p>Here we describe details of the spectra from the SDSS 
and BOSS spectrographs
...
href="dr9/spectro/spectro_basics.php">basics of SDSS spectra</a>.</p>

<h2 id="Spectrum">Spectrum information</h2>

<p>As described in the <a
href="dr9/spectro/spectro_access.php">data access
...
yields all 640 (SDSS) or 1000 (BOSS) spectra on each plate, each as a row in the image. These spectra
are flux- and wavelength-calibrated. Additional HDUs contain the wavelength solution, variances, masks,
and other information. </p>

<p>The logarithmic wavelength grid <em>spacing</em> is the same for all plates
  (log10 &lambda;<sub>i+1</sub> - log10 &lambda;<sub>i</sub> = 0.0001)
...
<td>heliocentric <a href="dr9/spectro/spectra.php#vacuum">vacuum
wavelengths</a></td>
</tr>
<tr>
<td>Fiber diameter</td>
<td>
  SDSS: 3 arcsec (180 microns) <br/>
  BOSS: 2 arcsec (120 microns) <br/>
</td>
</tr>
</table>
...
<p>
  ...
  <a href="instruments/boss_spectrograph.php">BOSS spectrograph</a>
  and the <a href="http://www.sdss.org/dr7/instruments/spectrographs/index.html">
    SDSS-I/-II spectrograph</a>
</p>
