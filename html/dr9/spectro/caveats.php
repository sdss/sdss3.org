...
<div class="summary">
	...
	caveats in SDSS Data Release 9 spectroscopic data.</p>
</div>

<h2>Caveats that affect <a href="dr9/spectro/caveats.php#allspec">all spectra</a></h2>
    <ol>
    <li><a href="dr9/spectro/caveats.php#balmerseries"><b>NEW:</b> Incorrectly-labeled Hydrogen Balmer line</a></li>   
    <li><a href="dr9/spectro/caveats.php#zstatus">Redshift Status</a></li>
    <li><a href="dr9/spectro/caveats.php#extinct">Galactic Extinction Correction</a></li>
    <li><a href="dr9/spectro/caveats.php#night_sky">Night Sky Emission Lines</a></li>
    <li><a href="dr9/spectro/caveats.php#sky_sub">Sky Subtraction</a></li>
    <li><a href="dr9/spectro/caveats.php#perfect">Coadd errors</a></li>
    <li><a href="dr9/spectro/caveats.php#galveldisp">Galaxy Velocity Dispersion Measurements</a></li>
    <li><a href="dr9/spectro/caveats.php#clipped">Clipped Spectral Lines</a></li>
    <li><a href="dr9/spectro/caveats.php#fakebalmerlines">Spectrophotometric calibration induces artificial Balmer lines</a></li>
    <li><a href="dr9/spectro/caveats.php#known_missing">Known missing or corrupted spectra files on SAS</a></li>
	<li><a href="dr9/spectro/caveats.php#responselimit">SkyServer returns "response buffer limit exceeded"</a></li>

    </ol>

<h2>Caveats that affect <a href="dr9/spectro/caveats.php#Boss">BOSS spectra</a> only</h2>
    <ol>
    <li><a href="dr9/spectro/caveats.php#target">Target selection problems in early BOSS data</a></li>
    <li><a href="dr9/spectro/caveats.php#class">Classification and redshift efficiency</a></li>
    <li><a href="dr9/spectro/caveats.php#noqso">NOQSO: galaxy fits without QSO templates</a></li>
    <li><a href="dr9/spectro/caveats.php#qso_redshifts">QSO pipeline redshifts</a></li>
    <li><a href="dr9/spectro/caveats.php#coadd">Mask Bits in Coadd</a></li>
    <li><a href="dr9/spectro/caveats.php#qsoflux">QSO Flux Calibration is Wrong</a></li>
    <li><a href="dr9/spectro/caveats.php#mask">Incomplete Masking</a></li>
    <li><a href="dr9/spectro/caveats.php#flux_cal">BOSS Flux Calibration</a></li>
    <li><a href="dr9/spectro/caveats.php#badfibers">Bad BOSS fiber 840</a></li>
	<li><a href="dr9/spectro/caveats.php#crosstalk">Artificial dichroic transitions at
	6000 &Aring; due to cross-talk from bright stars</a></li>
	<li><a href="dr9/spectro/caveats.php#washers">Correcting for wavelength dependence of
	focal plane when observing quasars</a></li>
	<li><a href="dr9/spectro/caveats.php#slowpokes">Position errors in some early plates in the
	Low-Mass Binary Stars ancillary target program</a></li>
    <li><a href="dr9/spectro/caveats.php#portsmouth">Problems with Portsmouth equivalent width
    and continuum flux measurements in the galaxy product.</a></li>
    </ol>


<h2>Caveats that affect <a href="dr9/spectro/caveats.php#Segue_Caveats">SEGUE spectra</a> only</h2>

<ol>
    <li><a href="dr9/spectro/caveats.php#Orphans">Missing DR9 Photometry</a></li>
    <li><a href="dr9/spectro/caveats.php#Duplicates">Duplicate Spectra</a></li>
    <li><a href="dr9/spectro/caveats.php#Quality_Cuts">Quality Cuts</a></li>
    <li><a href="dr9/spectro/caveats.php#obs_biases">Observational Biases</a></li>
</ol>

<h3>Caveats that affect stellar parameters from <a href="dr9/spectro/caveats.php#sspp">SSPP</a></h3>

        <ol>
        <li><a href="dr9/spectro/caveats.php#cc"> Correlation Coefficient</a></li>
        <li><a href="dr9/spectro/caveats.php#ston"> Signal-to-Noise Constraints</a></li>
        <li><a href="dr9/spectro/caveats.php#teff"> Effective Temperature Scale</a></li>
        <li><a href="dr9/spectro/caveats.php#grav"> Surface Gravity Determinations</a></li>
        <li><a href="dr9/spectro/caveats.php#rv"> Stellar Radial Velocities</a></li>
        <li><a href="dr9/spectro/caveats.php#beta"> SSPP Flags</a></li>

    </ol>

<h2>Other caveats</h2>

<h3><a href="dr9/spectro/caveats.php#phot_spec_match">Photometric-Spectroscopic Matching</a></h3>
<h3><a href="dr9/spectro/caveats.php#spec_plates">Specific Plates</a></h3>

<hr />
  <h2 id="allspec">Caveats that affect all spectra in DR9</h2>
      ...
      <h3 id="zstatus">Redshift status</h3>
        ...
        <p>
          ...
          the <a
        href="dr9/algorithms/bitmask_zwarning.php">
            <code>ZWARNING</code>
          </a>
	...
	not identical, to those used in SDSS-I/II.</p>
      ...
      <h3 id="extinct">Galactic extinction correction</h3>
        ...
        <p>
          The spectra released in DR9 have not been corrected for Galactic
      ...
      <h3 id="perfect">Coadd errors are not perfect</h3>
          ...
          <p> The default BOSS spectra distributed in DR9 are coadded
      ...
      <h3 id="galveldisp">Galaxy velocity dispersion measurements</h3>
        ...
        <p>
          See the <a href="dr9/algorithms/redshifts.php#veldisp">
            velocity dispersion
            algorithm
          </a> for details.
        </p>
    ...
    <h3 id="fakebalmerlines">Spectrophotometric calibration induces artificial Balmer lines</h3>
        ...
        <p>
          ...
          problem existed in DR8 and earlier as well as in DR9.
        </p>
...
<p>A <a href="http://skyserver.sdss3.org/dr9/en/tools/search/sql.asp">SQL Search</a> query
...
<p><a href="dr9/spectro/caveats.php">Back to top</a></p>
   ...
   <h2 id="Boss">Caveats that affect BOSS spectra</h2>
    ...
    <h3 id="target">Target selection issues in early BOSS data(<em>BOSS</em>)</h3>
        ...
        <p> The details of the targeting algorithm and photometric
          ...
          <!-- More details are
          available in <a href="dr9/tutorials/lss_galaxy.php">the LSS
    ...
    <p>The accuracy of the quasar redshift estimated by the BOSS
     ...
     redshifts are underestimated by about &plus;0.005 in <var>z</var>.
     Many of these QSOs have their redshifts fixed in the visual
     inspection step (with the corrected value in the
     <code>Z_PERSON</code> column of <code>specObj</code>).  </p>


    <h3 id="coadd">Mask Bits in Coadd (<em>BOSS</em>)</h3>

        <p>In the <a href="dr9/algorithms/bitmask_sppixmask.php">SPPIXMASK</a> associated with each spectrum, mask bit 24 (NODATA) should be ignored in the AND_MASK of
...
<p>In the DR9 data model, the value of <code>ZOFFSET</code> is given in microns
...
<a href="http://data.sdss3.org/sas/dr9/boss/spectro/redux/v5_4_45/spAll-v5_4_45.fits"><code>spAll</code></a>, and
<a href="http://data.sdss3.org/sas/dr9/sdss/spectro/redux/specObj-dr9.fits"><code>specObjAll</code></a>
files, and in
<a href="http://skyserver.sdss3.org">SkyServer&nbsp;<img src="images/offsite.png" alt="(offsite)" /></a>
in the
<a href="http://skyserver.sdss3.org/dr9/en/help/browser/description.asp?n=SpecObjAll&amp;t=U">
...
<h3 id="slowpokes">Position errors in some early plates in the
	<a href="dr9/algorithms/ancillary/lowmassbinary.php">Low-Mass Binary Stars</a> ancillary
	target program</h3>
...
available at the <a href="dr9/spectro/catalogs.php">SDSS Spectroscopic Catalogs</a> page.
...
SSPP and other estimates of stellar properties. <a href="dr9/spectro/duplicates.php">Duplicate SEGUE Observations</a> lists the stars with multiple observations. </p>
...
detailed in the <a href="dr9/tutorials/segue_sqlcookbook.php#Quality">SEGUE SQL Cookbook</a>.</p>
...
href="dr9/algorithms/segue_target_selection_weights.php">Target Selection
Weights</a> value-added catalog. Although DR9 contains corrections for
...
<p>Caveats that affect fitted parameters from SSPP</p>
   ...
   improves the reliability of the parameter estimates, especially at very low metallicity. </p>
    ...
    <h4 id="teff"> Effective Temperature Scale </h4>
        <p>
         The DR9 version of the SSPP adopts a much improved (<i>g-i</i>)-temperature
    ...
    <h4 id="grav"> Surface Gravity Determinations </h4>
        <p>
         ...
         the gravity estimates from MgH, CaI2, and k24, have been removed for DR9. Comparison
   ...
   <p>The DR9 SSPP has a flag 'B', which indicates that the
...
<p>Caveats that affect matching between photometric and spectroscopic data.</p>
     ...
     <h3 id="specphotomismatch">Mismatches between spectra and photometric data</h3>
        ...
        <p>
          ...
          such cases in DR9, which are marked as <code>UNPLUGGED</code> in the
          <code>
            <a
        href="dr9/algorithms/bitmask_zwarning.php">ZWARNING</a>
          </code>
        ...
        href="dr9/algorithms/match.php">
            spectroscopic-photometric matching
            documentation
          </a>.
        </p>

      <h3 id="Orphans">Missing SEGUE DR9 Photometry</h3>

   <p>The latest DR9 photometry is available for nearly
   all SEGUE objects; however, for a small fraction of fields (about 0.5%),
   the DR9 run of the photo pipeline timed out before it finished
   ...
   <p>
   There are about 12,500 stellar spectra in DR9 that have no
...
<p> 1) To extract spectra of objects with no DR9 photometry, search
...
<p>2) The PhotoObjDR7 and SpecDR7 tables match the objid from DR7 to those from DR8 and DR9. We can use
...
<p> Not all of the "orphan" spectra in DR9 have matching DR7 photometry, only around 5,300 do. Many of
the lines of sight missing DR9 photometry come from crowded fields, such as the <i>segcluster</i> pointings.</p>
...
<h2 id="spec_plates">Caveats that affect specific plates</h2>
    ...
    <h3>SAS-only plates</h3>
        ...
        <p>
          ...
          (see <a href="dr9/spectro/spectro_access.php">
            the spectroscopic data
            access page
          </a>) one will find files associated with a certain number
          of plates not listed in the <a
          href="http://data.sdss3.org/sas/dr9/sdss/spectro/redux/plates-dr9.par">
            DR9 list of plates
          </a> and not loaded into CAS. In essentially all cases,
          it is best to ignore such files and plates. For DR9, we went through
