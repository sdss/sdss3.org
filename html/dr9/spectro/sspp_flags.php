...
<p>The nominal condition for the five letter flag combination is 'nnnnn',
which indicates that the SSPP is satisfied that a given stellar
spectrum (and its reported <var>g</var>-<var>r</var> colors and S/N) has passed all of the
...
<table class="common">
    ...
    <tr>
        ...
        <td>Hot star with <var>T</var><sub>eff</sub> &gt; 10000 K</td>
        <td style="text-align:center;">Critical</td>
        <td style="text-align:center;">No</td>
    </tr>
    <tr>
