...
<a href="dr9/spectro/spectro_basics.php#vacuum">vacuum wavelengths</a>.</p>
...
spectrograph</a>. With Data Release 9, we release the first data from
...
href="dr9/scope.php#specstats">The Scope of DR9: Spectroscopic data
statistics</a>.</p>
...
href="http://skyserver.sdss3.org/dr9">SkyServer</a> uses a unique
number that encodes (64-bit hash) both plate-MJD-fiberID and the <a
href="dr9/help/glossary.php#run2d">RUN2D reduction value</a> of the <a
href="dr9/spectro/pipeline.php">spectroscopic redshift
pipeline</a>. This quantity, <a
href="dr9/help/glossary.php#specobj"><span
class="term">specObjID</span></a>, is unique to each spectrum. You
should use it to <a
href="http://skyserver.sdss3.org/dr9/en/help/howto/search/query3.asp">join
...
href="dr9/spectro/targets.php">targeting criteria</a> and <a
href="dr9/spectro/spectro_catalog_quality.php">data quality
...
BOSS survey PROGRAMNAME is "boss".  </p>
...
<p>Each spectrum was reduced by the SDSS <a href="dr9/spectro/pipeline.php">Spectroscopic
Pipeline</a>. The pipeline has changed slightly over time, so it is important to track
which version of the pipeline was used to reduce which spectra. Data Release 9 includes
...
<p>As of DR9, there are four possible values of <em>RUN2D</em>:</p>
<ul>
  <li>v5_4_45: the pipeline version used for BOSS</li>
...
href="dr9/spectro/targets.php">targeting criteria</a>, <a
href="dr9/spectro/spectra.php">the spectra themselves</a> and <a
href="dr9/spectro/catalogs.php">catalog information</a>, including
...
href="dr9/spectro/galaxy.php">galaxy parameter measurements</a> and <a
href="dr9/spectro/sspp.php">stellar parameter measurements</a> from
the spectra.</p>
...
As described in the <a href="dr9/spectro/spectro_access.php">data
