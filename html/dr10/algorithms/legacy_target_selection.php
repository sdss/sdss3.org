...
<ul>
<li><a href="dr10/algorithms/legacy_target_selection.php#main">Main Galaxy Sample</a></li>
<li><a href="dr10/algorithms/legacy_target_selection.php#lrg">Luminous Red Galaxies</a></li>
<li><a href="dr10/algorithms/legacy_target_selection.php#qso">Quasars</a></li>
<li><a href="dr10/algorithms/legacy_target_selection.php#stars">Stars</a></li>
<li><a href="dr10/algorithms/legacy_target_selection.php#ROSAT">ROSAT All-Sky Survey Sources</a></li>
<li><a href="dr10/algorithms/legacy_target_selection.php#serendip">Serendipity targets</a></li>
<li><a href="dr10/algorithms/legacy_target_selection.php#references">References</a></li>
</ul>
...
<a href="dr10/algorithms/classify.php#photo_class">star-galaxy separation</a> cut used by Photo (galaxies targeted off
...
<a href="dr10/algorithms/flags_detail.php">the descriptions of flags</a>.
The
<a href="dr10/algorithms/magnitudes.php#mag_petro">Petrosian</a>
...
href="dr10/algorithms/classify.php#photo_sb"> Petrosian half-light
...
href="dr10/algorithms/magnitudes.php#mag_fiber"> fiber magnitudes</a>
...
<p><a href="dr10/algorithms/legacy_target_selection.php#Top">[Back to top]</a></p>
...
<a href="dr10/algorithms/magnitudes.php#mag_model">
...
(see <a href="dr10/algorithms/flags_detail.php">flag descriptions</a>)
...
target selection paper (<a href="dr10/algorithms/legacy_target_selection.php#references">referenced
below</a>).</p>
...
as outliers from the stellar locus, modeled following <a
...
using <a href="dr10/algorithms/magnitudes.php#mag_psf"> PSF
...
href="dr10/algorithms/flags_detail.php">flag
...
href="dr10/algorithms/legacy_tiling.php">tiled</a>.</p>
...
<li> brown dwarfs (STAR_BROWN_DWARF) - this is the only <a
    href="dr10/algorithms/legacy_tiling.php">tiled</a> sample of stars</li>
...
<li> central stars of planetary nebulae (STAR_PN)</li>
     ...
     <p>For more information on these, please see <a href="dr10/algorithms/segue_target_selection.php#Legacy">
SEGUE Target Selection</a>.</p>
