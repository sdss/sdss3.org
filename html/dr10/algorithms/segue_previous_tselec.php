...
<a href="dr10/algorithms/segue_target_selection.php#v4.6">4.6</a>. Here we list the previous
...
<ul>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v4.0">v4.0</a></li>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v3.4">v3.4</a></li>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v3.3">v3.3</a></li>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v3.2">v3.2</a></li>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v3.2">v3.1</a></li>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v3.2">v3.0</a></li>
<li><a href="dr10/algorithms/segue_previous_tselec.php#v2.0">v2.0</a></li>
</ul>
...
<li>Low Metallicity
<ul>
<li>New for v 3.1:  We also weight by <a href="dr10/algorithms/segue_target_selection.php#lcolor">l-color</a> to
...
<ul>
    ...
    <li>A/BHB
        <ul>
            ...
            <a href="dr10/algorithms/segue_target_selection.php#scolor">s-color</a> &lt; -0.065 </li>
    ...
    <li>F turnoff, subdwarf
        <ul>
            <li>-0.7 &lt; <a href="dr10/algorithms/segue_target_selection.php#P1">p1(s)</a> &lt; <b>-0.25</b>, 0.4 &lt; u-g &lt; <b>1.4</b>,
    ...
    <li>K Giant
        <ul>
            ...
            <a href="dr10/algorithms/segue_target_selection.php#lcolor">l-color</a> &gt; <b>0.07</b></li>
    ...
    <li>AGB candidate selection
        <ul>
            ...
            <a href="dr10/algorithms/segue_target_selection.php#scolor">s-color</a> &lt; <b>-0.06</b></li>
...
<ul>
    ...
    <li>K Giant Selection
        <ul>
            ...
            0.15 &lt; r-i &lt; 0.6, <a href="dr10/algorithms/segue_target_selection.php#lcolor">l-color</a> &gt; 0.1</li>
    ...
    <li>Low Metallicity selection
        <ul>
            ...
            <a href="dr10/algorithms/segue_target_selection.php#lcolor">l-color</a> &gt; 0.15</li>
            <li>Weighting: colorslope</li>
            <li>Target count Goal: 150 per plate pair</li>
        </ul>
    </li>
    ...
    <li>AGB candidate selection
        <ul>
            ...
            <a href="dr10/algorithms/segue_target_selection.php#scolor">s-color</a> &lt; -0.07</li>
