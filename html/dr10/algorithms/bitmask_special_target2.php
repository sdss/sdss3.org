<?php include '../../header.php'; echo head('Secondary target mask bits in SDSS-I, -II'); ?>


<p>
These bitmask values are appropriate for the following bitmasks used for SDSS-I and -II:
LEGACY_TARGET2, SPECIAL_TARGET2 or SECTARGET.</p>
