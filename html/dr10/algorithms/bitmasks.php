...
<p>SDSS-III makes heavy use of the concept of a <span class="term">bitmask</span> 
in <a href="dr10/spectro/targets.php">spectroscopic target flags</a> and other contexts. 
For the
actual bit values for all SDSS-III flags, see the other links on the
left-side panel. There is also some documentation on 
<a href="dr10/algorithms/segue_bit_guide.php">bitmasks in the SEGUE survey</a>. 
What follows below is a primer for those who have
...
href="dr10/algorithms/bitmask_cas.php">CAS</a> 
and <a href="dr10/algorithms/bitmask_idl.php">
idlutils</a> (for those using IDL to look at the flat files).  </p>
...
<p>Within SDSS-III, the most common use of a bitmask is to
