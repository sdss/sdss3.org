...
classification, and velocity dispersion methods, described in detail in <a href="http://adsabs.harvard.edu/abs/2012arXiv1207.7326B">Bolton <em>et&nbsp;al.</em> (2012)</a>.</p>
</div>

<h2 id="intro">Introduction</h2>

<p>The software used is called <code>idlspec2d</code> and is publicly
available in our <a href="dr10/software/">software
repository</a>.   Note that for galaxy targets in the DR9 and later BOSS CMASS and
...
galaxies, and quasars, as described in <a href="http://adsabs.harvard.edu/abs/2012arXiv1207.7326B">Bolton <em>et&nbsp;al.</em> (2012)</a>.</p>
...
in a flag called <a
href="dr10/algorithms/bitmask_zwarning.php">ZWARNING</a>; if ZWARNING=0
...
spectra in previous data releases.  For BOSS DR9 and later
...
<a href="dr10/spectro/catalogs.php#objects">spectro catalogs</a> page for
...
<!-- SDSS publication 87 -->
<p>Bolton, A. S., Schlegel, D. J., Aubourg, E., Bailey, S., Bizyaev D.,
...
Pan, K., Paris, I., Percival, W. J., Petitjean, P., Ross, N. P.,
Schneider, D. P., Shelden A., Shu, Y., Simmons, A., Snedden, S.,
Strauss, M. A., Thomas. D., Tremonti, C. A., Wake, D. A., Weaver, B. A.,
Wood-Vasey, W. M., 2012, submitted to AJ, <a href="http://arxiv.org/abs/1207.7326">arXiv:1207.7326</a>.</p>
