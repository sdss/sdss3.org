...
href="dr10/help/glossary.php#plate">plates</a> are designed
and placed relative to each other. This procedure involves optimizing
both the placement of <a
href="dr10/help/glossary.php#fiber">fibers</a> on individual
...
<ul>
<li><a href="dr10/algorithms/legacy_tiling.php#survey">Spectro Survey Overview</a></li>
<li><a href="dr10/algorithms/legacy_tiling.php#tiling">What is tiling?</a></li>
<li><a href="dr10/algorithms/legacy_tiling.php#fiber_placement">Fiber Placement</a></li>
<li><a href="dr10/algorithms/legacy_tiling.php#collisions">Dealing with Fiber Collisions</a></li>
<li><a href="dr10/algorithms/legacy_tiling.php#tile_placement">Tile Placement</a></li>
<li><a href="dr10/algorithms/legacy_tiling.php#tech_details">Technical Details</a></li>
<li><a href="dr10/algorithms/legacy_tiling.php#tiling_window">Tiling Window</a></li>
</ul>
...
<p><a href="dr10/algorithms/legacy_tiling.php#Top">[Back to top]</a></p>
...
known in SDSS parlance as a <a href="dr10/help/glossary.php#tile_region">tiling region</a>. </p>
...
flow algorithm of the <a href="dr10/algorithms/legacy_tiling.php#fiber_placement">above section</a> to the
set of decollided
...
explained in <a href="dr10/algorithms/legacy_target_selection.php">the targeting pages</a>, QSOs are
...
described in the <a href="dr10/algorithms/legacy_target_selection.php">targetting pages</a>). They consist
...
<a href="dr10/help/glossary.php#survey_coords">survey
...
href="dr10/help/glossary.php#tilable">tilable targets</a>
...
href="dr10/algorithms/masks.php">photometric imaging mask</a>)</li>
<li>Target selection (requires understanding the <a
href="dr10/algorithms/legacy_target_selection.php">target selection algorithms</a>)</li>
<li>Tiling (the algorithm is described above)</li>
<li>Spectroscopic completeness (whether or not <a href="dr10/spectro/">
...
href="dr10/help/glossary.php#tile">tile</a>.</p>

<p>The way to understand the tiling window is as follows. In each
direction of the sky we can ask two questions:</p>
<ol>
<li>what version of <a href="dr10/algorithms/legacy_target_selection.php"> the
...
<p>The <a href="dr10/data_access/#catalog">Catalog Archive
