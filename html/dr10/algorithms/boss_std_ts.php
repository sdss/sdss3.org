...
In the following, we use <a href="dr10/algorithms/magnitudes.php#mag_psf">PSF magnitudes</a>.
...
<p>
We select stars by demanding <code><a href="dr10/algorithms/classify.php">objc_type</a> == 6</code>.</p>
...
<pre>
    STATIONARY     in <a href="dr10/algorithms/bitmask_flags2.php">OBJECT2</a> objc flags
    SURVEY_PRIMARY in <a href="dr10/algorithms/bitmask_resolve_status.php">RESOLVE_STATUS</a> flags
    PHOTOMETRIC    in <a href="dr10/algorithms/bitmask_calib_status.php">CALIB_STATUS</a> flags.
</pre>
<p>
Standards must not be
</p>
<pre>
    in <a href="dr10/algorithms/bitmask_flags1.php">OBJECT1</a> objc_flags
        BLENDED, TOO_MANY_PEAKS, CR, SATUR, BADSKY

    in <a href="dr10/algorithms/bitmask_flags2.php">OBJECT2</a> objc_flags2
