...
<dl>
<dt>trunk</dt><dd>holds the very latest development version of the software.
Stability is not guaranteed, but if you need to track developments in 'real time',
you should check out trunk.</dd>
<dt>tags</dt><dd>holds labeled versions of the software that are intended for
release.</dd>
<dt>branches</dt><dd>holds active development areas that are meant to be
kept separate from trunk.  Only experts should look here.</dd>
</dl>

<p>If you <i>only</i> want a copy of the software, a subversion export is
the best option.  For example to download version v5_5_5 of idlutils:</p>
...
<li>apogee
    <ul>
        <li><a href="http://www.sdss3.org/svn/repo/apogee/apogeereduce">apogeereduce</a></li>
        <li><a href="http://www.sdss3.org/svn/repo/apogee/apogeetarget">apogeetarget</a></li>
        <li>aspcap
            <ul>
                <li><a href="http://www.sdss3.org/svn/repo/apogee/aspcap/idlwrap">idlwrap</a></li>
                <li><a href="http://www.sdss3.org/svn/repo/apogee/aspcap/speclib">speclib</a></li>
            </ul>
        </li>
    </ul>
</li>
<li><a href="http://www.sdss3.org/svn/repo/calibplate">calibplate</a></li>
<li><a href="http://www.sdss3.org/svn/repo/CasJobs">CasJobs</a></li>
...
<li><a href="http://www.sdss3.org/svn/repo/cosmoxi2d">cosmoxi2d</a></li>
...
<li>legacy
    <ul>
        <li><a href="http://www.sdss3.org/svn/repo/legacy/plate">plate</a></li>
    </ul>
</li>
<li><a href="http://www.sdss3.org/svn/repo/photolog">photolog</a></li>
<li><a href="http://www.sdss3.org/svn/repo/photoop">photoop</a></li>
<li><a href="http://www.sdss3.org/svn/repo/platedesign">platedesign</a></li>
<li><a href="http://www.sdss3.org/svn/repo/platelist">platelist</a></li>
...
<li><a href="http://www.sdss3.org/svn/repo/segue">segue</a>
    <ul>
        <li><a href="http://www.sdss3.org/svn/repo/segue/sspp">sspp</a></li>
        <li><a href="http://www.sdss3.org/svn/repo/segue/tgtselection">tgtselection</a></li>
        <li><a href="http://www.sdss3.org/svn/repo/segue/tsDR8">tsDR8</a></li>
    </ul>
</li>
<li><a href="http://www.sdss3.org/svn/repo/skyServer">skyServer</a></li>
<li><a href="http://www.sdss3.org/svn/repo/sm">sm</a></li>
<li><a href="http://www.sdss3.org/svn/repo/specflat">specflat</a></li>
<li><a href="http://www.sdss3.org/svn/repo/speclog">speclog</a></li>
<li><a href="http://www.sdss3.org/svn/repo/sqlLoader">sqlLoader</a></li>
<li><a href="http://www.sdss3.org/svn/repo/voyages">voyages</a></li>
...
<tr><td>idlspec2d</td><td>idlutils</td><td>elodie, platelist, specflat, speclog</td></tr>
...
<tr><td>platedesign</td><td>photoop</td><td>platelist, plate</td></tr>
