...
<ul>
<li><a href="dr10/spectro/galaxy_portsmouth.php#fitting">Spectro-Photometric Model Fitting</a></li>
<li><a href="dr10/spectro/galaxy_portsmouth.php#kinematics">Stellar Kinematics and Emission Line Fluxes</a></li>
<li><a href="dr10/spectro/galaxy_portsmouth.php#data">Data Access</a></li>
</ul>
...
<ul>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+stellarMassPassivePort+U">Table stellarMassPassivePort</a></li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+stellarMassStarFormingPort+U">Table stellarMassStarformingPort</a></li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+emissionLinesPort+U">Table emissionLinesPort</a></li>
</ul>
...
<p>You may download data based on the <a href="http://data.sdss3.org/datamodel/files/BOSS_GALAXY_REDUX/GALAXY_VERSION/portsmouth_stellarmass.html">Portsmouth Stellar Mass Passive datamodel</a>
 from:</p>
<p><b>passive_krou:</b></p>
<ul>
<li><a href="http://data.sdss3.org/sas/dr10/boss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_passive_krou-v5_5_12.fits.gz">portsmouth_stellarmass_passive_krou-v5_5_12.fits.gz</a> [BOSS DR10], </li>
<li><a href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_passive_krou-26.fits.gz">portsmouth_stellarmass_passive_krou-26.fits.gz</a> [SDSS DR8].</li>
</ul>
<p><b>passive_salp:</b></p>
<ul>
<li><a href="http://data.sdss3.org/sas/dr10/boss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_passive_salp-v5_5_12.fits.gz">portsmouth_stellarmass_passive_salp-v5_5_12.fits.gz</a> [BOSS DR10], </li>
<li><a href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_passive_salp-26.fits.gz">portsmouth_stellarmass_passive_salp-26.fits.gz</a> [SDSS DR8].</li>
</ul>
<p>You may download data based on the <a href="http://data.sdss3.org/datamodel/files/BOSS_GALAXY_REDUX/GALAXY_VERSION/portsmouth_stellarmass.html">Portsmouth Stellar Mass Star Forming datamodel</a>
from:</p>
<p><b>starforming_krou:</b></p>
<ul>
<li><a href="http://data.sdss3.org/sas/dr10/boss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_starforming_krou-v5_5_12.fits.gz">portsmouth_stellarmass_starforming_krou-v5_5_12.fits.gz</a> [BOSS DR10], </li>
<li><a href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_starforming_krou-26.fits.gz">portsmouth_stellarmass_starforming_krou-26.fits.gz</a> [SDSS DR8].</li>
</ul>
<p><b>starforming_salp:</b></p>
<ul>
<li><a href="http://data.sdss3.org/sas/dr10/boss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_starforming_salp-v5_5_12.fits.gz">portsmouth_stellarmass_starforming_salp-v5_5_12.fits.gz</a> [BOSS DR10], </li>
<li><a href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/galaxy/v1_0/portsmouth_stellarmass_starforming_salp-26.fits.gz">portsmouth_stellarmass_starforming_salp-26.fits.gz</a> [SDSS DR8].</li>
</ul>
<p>You may download the data based on the <a href="http://data.sdss3.org/datamodel/files/BOSS_GALAXY_REDUX/GALAXY_VERSION/portsmouth_emlinekin.html">Portsmouth Emission-Line Kinematics datamodel</a>
</p>
<p><b>summary:</b></p>
<ul>
<li><a href="http://data.sdss3.org/sas/dr10/boss/spectro/redux/galaxy/v1_0/portsmouth_emlinekin-v5_5_12.fits.gz">portsmouth_emlinekin-v5_5_12.fits.gz</a> [BOSS DR10], </li>
<li><a href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/galaxy/v1_0/portsmouth_emlinekin-26.fits.gz">portsmouth_emlinekin-26.fits.gz</a> [SDSS DR8].</li>
</ul>
<p><b>full:</b></p>
<ul>
<li><a href="http://data.sdss3.org/sas/dr10/boss/spectro/redux/galaxy/v1_0/portsmouth_emlinekin_full-v5_5_12.fits.gz">portsmouth_emlinekin_full-v5_5_12.fits.gz</a> [BOSS DR10], </li>
<li><a href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/galaxy/v1_0/portsmouth_emlinekin_full-26.fits.gz">portsmouth_emlinekin_full-26.fits.gz</a> [SDSS DR8].</li>
</ul>
...
<p>White, M., Blanton, M., Bolton, A., Schlegel, D., Tinker, J., Berlind, A.,
da Costa, L., Kazin, E., Lin, Y.T., Maia, M., McBride, C.K., Padmanabhan, N.,
Parejko, J., Percival, W., Prada, F., Ramos, B., Sheldon, E., de Simoni, F.,
Skibba, R., Thomas, D., Wake, D., Zehavi, I., Zheng, Z., Nichol, R.,
Schneider, D.P., Strauss, M.A., Weaver, B.A., Weinberg, D.H.,
2011, ApJ, 728, 126,
<a href="http://dx.doi.org/10.1088/0004-637X/728/2/126">doi:10.1088/0004-637X/728/2/126</a>.</p>
