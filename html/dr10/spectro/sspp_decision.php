...
<a href="dr10/spectro/sspp_methods.php">table</a>. <strong>Among the parameters, it
...
<p>There are nine temperature estimates determined by the DR9 SSPP. 
Averages are taken from these nine estimators using the robust 
biweight procedure (See Beers, Flynn, &amp; Gebhardt 1990, and references
therein). There is also an average temperature estimate 
based on the methods (<a href="dr10/spectro/sspp_methods.php">ki13, ANNSR, ANNRR, 
NGS1, HA24, and HD24</a>), which do not use any color information. A robust average of the
...
<p>There are eight methods used to
...
average of the accepted log <i>g</i> estimates (those with indicator
...
<p>There are 10 estimates of [Fe/H] in the SSPP. We adopt the validity
ranges of S/N and g-r listed in the <a href="dr10/spectro/sspp_methods.php">table</a>
...
of the CC and MAR (maximum of <i>N</i>=10)
for the <i>N</i> estimates of [Fe/H] with indicator variables of 1.</p>
