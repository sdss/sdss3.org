...
<li> Metallicity determined from Auto-correlation Function (ACF), 
     Ca II triplet line index (CaIIT) method, and <a href="dr10/spectro/sspp_methods.php">ANNSR</a> is no longer 
     reported and does not contribute to the best metallicity estimate for each star. </li>
<li>Gravity estimate from (MgH) and (CaI2) line index methods and <a href="dr10/spectro/sspp_methods.php">k24</a> is 
    not reported any more and does not contribute to the best gravity estimate 
    for each star.</li>
<li><a href="dr10/spectro/sspp_methods.php">NGS1</a> and <a href="dr10/spectro/sspp_methods.php">CaIIK1</a> make use of a new grid of synthetic spectra
...
<li>The grid of synthetic spectra used in the <a href="dr10/spectro/sspp_methods.php">NGS1</a>, 
    <a href="dr10/spectro/sspp_methods.php">CaIIK1</a>, and
...
<li>Instead of linear interpolation, cubic spline interpolation is implemented 
    for <a href="dr10/spectro/sspp_methods.php">k24</a>, <a href="dr10/spectro/sspp_methods.php">ki13</a>, 
    <a href="dr10/spectro/sspp_methods.php">NGS1</a>, <a href="dr10/spectro/sspp_methods.php">NGS2</a>, and 
    <a href="dr10/spectro/sspp_methods.php">CaIIK1</a> during &chi;<sup>2</sup> minimization. 
...
<li> A new set of <a href="dr10/spectro/sspp_methods.php">g-r and S/N limits</a> is introduced for individual
...
<li> New neural networks trained on new grid of synthetic spectra and the DR8
     parameters are implemented for <a href="dr10/spectro/sspp_methods.php">ANNSR</a> and 
     <a href="dr10/spectro/sspp_methods.php">ANNRR</a>, respectively.</li>
...
<li> Effective temperature based on the <a href="dr10/spectro/sspp_irfm.php">InfraRed Flux Method (IRFM)</a> 
     is estimated, using g-i, log <i>g</i>, and [Fe/H] from <a href="dr10/spectro/sspp_methods.php">NGS1</a>.</li>
<li> A comparison with the DR8 stellar parameters indicates that the DR9
     ...
     <a href="dr10/spectro/sspp_methods.php">NGS1</a>, <a href="dr10/spectro/sspp_methods.php">NGS2</a>, 
     and <a href="dr10/spectro/sspp_methods.php">CaI</a>. However, the biggest causes of this shift are the retirement of the
