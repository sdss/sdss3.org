...
<p>Our <a href="dr10/tutorials">tutorials</a> include <a href="dr10/tutorials/segue_getting_started.php">how 
to get started using SEGUE data</a> and a more in-depth description of <a href="dr10/tutorials/segue_sqlcookbook.php">how to access SEGUE data with CASJobs</a>.</p>


<h2>Details</h2>

<ul>
<li><a href="dr10/spectro/sspp_changes.php">List of Changes and Improvements Since DR8</a></li>
<li><a href="dr10/spectro/sspp_irfm.php">Temperature Estimate from InFred Flux Method (IRFM)</a></li>
<li><a href="dr10/spectro/sspp_calibration.php">Re-calibration of SSPP Parameters</a></li>
<li><a href="dr10/spectro/sspp_lineindexmeas.php">Line Index Measurements in SSPP</a></li>
<li><a href="dr10/spectro/sspp_methods.php">Individual Methods Used in SSPP</a></li>
<li><a href="dr10/spectro/sspp_flags.php">Flags in SSPP</a></li>
<li><a href="dr10/spectro/sspp_decision.php">Decision Tree on Temperature, Gravity, and Metallicities</a></li>
<li><a href="dr10/spectro/sspp_plots.php">SSPP Output Plots</a></li>
<li><a href="dr10/spectro/sspp_hires.php">Comparisons of SSPP Parameters with High-resolution Analysis</a></li>
<li><a href="dr10/spectro/sspp_clusters.php">Comparisons of SSPP Parameters with Clusters</a></li>
<li><a href="dr10/spectro/sspp_internal.php">Internal Consistency of Each Parameter in SSPP</a></li>
<li><a href="dr10/spectro/caveats.php#sspp">Caveats for SSPP Parameters</a></li>
<li><a href="dr10/spectro/sspp_data.php">Accessing SSPP Parameters</a></li>
</ul>

<h2>[&alpha;/Fe] Measurements</h2>

<p>There is measurement of [&alpha;/Fe] ratio by the SSPP, and 
there is <a href="dr10/spectro/alpha_catalog.php">value added catalog</a> for this in 
