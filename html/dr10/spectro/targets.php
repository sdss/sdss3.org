...
select only objects that were (or were not) targeted within any
targeting program. The descriptions below and their links explain what
the various types of <a
href="dr10/glossary.php#programname">programname</a> values mean.</p>
</div>


<p>If you are not familiar with what a bitmask is, please see
our <a href="dr10/algorithms/bitmasks.php">bitmask primer</a>. In addition,
we'll discuss below the differences between various SDSS-III surveys
and programs; please see the <a
href="dr10/spectro/spectro_basics.php">basics
...
one of the <a
href="dr10/algorithms/bitmask_legacy_target1.php">LEGACY_TARGET1</a> bits
...
<ol>
<li><a href="dr10/algorithms/bitmask_legacy_target1.php">LEGACY_TARGET1</a>: primary target bits for Legacy science targets</li>
<li><a href="dr10/algorithms/bitmask_legacy_target2.php">LEGACY_TARGET2</a>: secondary target bits for Legacy targets</li>
<li><a href="dr10/algorithms/bitmask_segue1_target.php">SEGUE1_TARGET1</a>: primary target bits for SEGUE-1 science targets</li>
<li><a href="dr10/algorithms/bitmask_legacy_target2.php">SEGUE1_TARGET2</a>: secondary target bits for SEGUE-1 targets</li>
<li><a href="dr10/algorithms/bitmask_segue2_target1.php">SEGUE2_TARGET1</a>: primary target bits for SEGUE-2 science targets</li>
<li><a href="dr10/algorithms/bitmask_legacy_target2.php">SEGUE2_TARGET2</a>: secondary target bits for SEGUE-2 targets</li>
<li><a href="dr10/algorithms/bitmask_special_target1.php">SPECIAL_TARGET1</a>: primary target bits for special program science targets</li>
<li><a href="dr10/algorithms/bitmask_special_target2.php">SPECIAL_TARGET2</a>: secondary target bits for special program targets</li>
<li><a href="dr10/algorithms/bitmask_boss_target1.php">BOSS_TARGET1</a>: BOSS primary survey targets</li>
<li><a href="dr10/algorithms/bitmask_ancillary_target1.php">ANCILLARY_TARGET1</a>: BOSS ancillary programs 1</li>
<li><a href="dr10/algorithms/bitmask_ancillary_target2.php">ANCILLARY_TARGET2</a>: BOSS ancillary programs 2</li>
</ol>
...
<p>The <a href="dr10/algorithms/segue_target_selection.php#SEGUEts2">SEGUE target selection algorithms
documentation</a> describes the meaning of the bits of these
flags.</p>
...
the
<a href="dr10/algorithms/segue_target_selection.php#seguecluster">SEGUE cluster plates target selection</a> documentation.</p>
...
<p>The <a href="dr10/algorithms/legacy_special_target.php">special programs target
...
<p>Please see our <a
href="dr10/algorithms/boss_target_selection.php">overview of the BOSS
target selection</a>. The individual target selection algorithms for
BOSS are described in the <a
href="dr10/algorithms/boss_galaxy_ts.php">BOSS LRG target
selection</a>, <a href="dr10/algorithms/boss_quasar_ts.php">BOSS quasar
target selection</a> and <a href="dr10/algorithms/ancillary/boss/">BOSS
