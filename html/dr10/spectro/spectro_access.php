...
href="dr10/spectro/spectro_basics.php">Understanding SDSS Spectroscopic
Data</a> and the <a href="http://data.sdss3.org/datamodel">data
model</a>.</p>

<p>Methods for accessing these data are summarized on the <a
href="dr10/data_access/">data access</a> page.
Also see the <a
href="dr10/spectro/pipeline.php">spectro pipeline</a> page for
