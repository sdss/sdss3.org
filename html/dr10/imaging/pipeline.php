...
<p>More detail is available in the <a href="dr10/algorithms/">Algorithms</a>
...
The Data Release 9 paper describes some changes to astrometry algorithms that occurred
with DR9 and later.
</p>
...
<ul>
<li><a href="dr10/imaging/pipeline.php#imobs"><b>Imaging Observing</b></a><br />
...
<li><a href="dr10/imaging/pipeline.php#imred"><b>Imaging Data Reduction</b></a><br />
...
<li><a href="dr10/imaging/pipeline.php#resolve"><b>Resolution of Multiple Detections</b></a><br />
...
-->
<li><a href="dr10/imaging/pipeline.php#ubercal"><b>Recalibration</b></a><br />
...
calibrations.</li>
<li><a href="dr10/imaging/pipeline.php#catalogs"><b>Final Photometric Catalog</b></a><br />
...
<ul>
<li>In the tables below, add 'http://data.sdss3.org/sas/dr10/' to all 'URL format'
...
the <a href="dr10/imaging/images.php#psf">extracting
...
<p>The astrometric pipeline calculates the astrometric solution. The <a href="dr10/algorithms/astrometry.php">astrometry</a>
...
<ul>
<li><a href="dr10/algorithms/magnitudes.php">Measures
of flux and magnitudes</a> describes the variety of methods
frames uses to measure the magnitude of each object,
including
<a href="dr10/algorithms/magnitudes.php#photo_profile">radial
profiles</a>,
<a href="dr10/algorithms/magnitudes.php#mag_fiber">fiber</a>,
<a href="dr10/algorithms/magnitudes.php#mag_model">model</a>,
<a href="dr10/algorithms/magnitudes.php#cmodel">cModel</a>,
<a href="dr10/algorithms/magnitudes.php#mag_petro">Petrosian</a> and
<a href="dr10/algorithms/magnitudes.php#mag_psf">PSF</a>
magnitudes and
<a href="dr10/algorithms/magnitudes.php#which_mags">when to use each</a>.</li>
<li><a href="dr10/algorithms/classify.php">Classification
and Morphology</a> describes other measurements of objects,
including
<a href="dr10/algorithms/classify.php#photo_class">star/galaxy separation</a>,
<a href="dr10/algorithms/classify.php#photo_fits">model fits</a>,
<a href="dr10/algorithms/classify.php#photo_sb">surface brightnesses</a>,
<a href="dr10/algorithms/classify.php#photo_stokes">ellipticities</a>,
<a href="dr10/algorithms/classify.php#photo_adaptive">adaptive
moments</a> and
<a href="dr10/algorithms/classify.php#photo_iso">isophotal quantities</a>.</li>
<li><span style="color:red;">IMPORTANT!</span> <a href="dr10/algorithms/photo_flags.php">Photometric
processing flags</a> describes the variety of flags frames
sets for each object, essential for properly interpreting
the catalog.</li>
<li><a href="dr10/algorithms/fluxcal.php#counts2mag">Flat
...
<li><a href="dr10/algorithms/sky.php">Sky measurement</a></li>
<li><a href="dr10/algorithms/deblend.php">Deblending</a>
...
<li><a href="dr10/algorithms/masks.php">Creation of imaging masks</a></li>
</ul>
...
<td>out</td>
<td>the frame masks (read using <a href="dr10/imaging/images.php#readAtlasImages">readAtlasImages</a>)</td>
...
<td>out</td>
<td>the atlas images for all objects detected (read using <a href="dr10/imaging/images.php#readAtlasImages">readAtlasImages</a>)</td>
...
calibration of a run, but now the <a href="dr10/imaging/pipeline.php#ubercal">"ubercal"
calibrations</a> supersede these "final" calibrations.</p>

<p>The <a href="dr10/algorithms/fluxcal.php">photometric
flux calibration algorithms page</a> describes the calibration
and use of calibrated quantities in more detail, and includes
sections on
<a href="dr10/algorithms/fluxcal.php#assessment">assessment of
photometric calibration</a>,
<a href="dr10/algorithms/fluxcal.php#counts2mag">converting SDSS counts to
SDSS (asinh) magnitudes</a> (and <em>vice versa</em>),
<a href="dr10/algorithms/fluxcal.php#SDSStoAB">converting SDSS to AB
magnitudes</a>, and
<a href="dr10/algorithms/fluxcal.php#SDSStoflux">converting SDSS
asinh magnitudes to fluxes.</a>
<a href="dr10/algorithms/sdssUBVRITransform.php">Another
...
the entire survey. See the <a href="dr10/algorithms/fluxcal.php">photometric
...
<tr>
<td><a href="http://data.sdss3.org/sas/dr10/boss/calib/dr8_final/plots/">calib</a></td>
<td>out</td>
