...
metadata associated with each field and run. This page describes
how to use the imaging catalogs. For more detail on how the catalogs
were created, see the <a href="dr10/algorithms/">Algorithms</a> pages.</p>

<p>To understand the imaging data, you first need an understanding of
the <a href="dr10/imaging/imaging_basics.php">basic imaging data
information</a>.
Below we refer to the <a href="dr10/algorithms/">algorithms</a>
...
to look at the <a href="dr10/algorithms/flags_detail.php">object flags</a> in the
...
is <a href="dr10/help/glossary.php#ObjID"><code>objID</code></a>, which
...
<p>In the flat files on SAS, the <a
...
href="dr10/help/glossary.php#field">field</a>. The files are binary fits
...
many purposes the <a href="dr10/imaging/catalogs.php#sweeps">sweeps</a>
...
href="dr10/software/">SDSS software</a> contains code to read in the
...
described in the <a href="dr10/algorithms/resolve.php">resolve
...
discussion of these flags <a href="dr10/algorithms/flags_detail.php">object
...
described in the <a
href="dr10/algorithms/magnitudes.php">magnitude</a> and <a
href="dr10/algorithms/classify.php">classification</a> algorithms pages. The
algorithms pages also describe the <a
href="dr10/algorithms/fluxcal.php">ubercalibration</a> and other
...
the data in the
<a href="dr10/imaging/catalogs.php#photoObj"><code>photoObj</code></a>
...
<a href="dr10/algorithms/magnitudes.php#mag_model">model magnitude</a>
...
<a href="dr10/algorithms/magnitudes.php#mag_psf">PSF magnitude</a>
...
statistics about the ensemble flux distribution are stored.  For <code>model,
cmodel, psf</code> flux types, there are additional fields for the "clean"
...
href="dr10/imaging/catalogs.php#photoObj"><code>photoObj</code></a>
files, there is one <code>calibObj</code> file per <a
href="dr10/help/glossary.php#camcol">camcol</a>.  There is also a separate
...
<p>
See the <a href="dr10/software/">software page</a>
...
<a href="dr10/help/glossary.php#primary"><code>SURVEY PRIMARY</code></a>
objects.  See the <a href="dr10/algorithms/resolve.php"><code>resolve</code></a>
...
<a href="dr10/algorithms/flags_detail.php">object flags</a> for a full description
...
<ol>
<li><a href="dr10/algorithms/image_quality.php">image quality
flags</a></li>
<li><a href="dr10/algorithms/fluxcal.php">flux calibration information</a></li>
<li><a href="dr10/imaging/images.php#psf">point-spread function
quantities</a></li>
<li><a href="dr10/algorithms/sky.php">sky measurement quantities</a></li>
<li><a href="dr10/algorithms/astrometry.php">astrometric calibrations</a></li>
</ol>

<p>The following information is included for each run:</p>
<ol>
<li><a href="dr10/help/glossary.php#mjd">date of observation</a></li>
<li><a href="dr10/help/glossary.php#stripe">stripe</a> and <a
href="dr10/help/glossary.php#strip">strip</a> designation</li>
<li>starting and ending <a href="dr10/help/glossary.php#field">field</a>
numbers</li>
</ol>
...
(click <a
href="http://data.sdss3.org/sas/dr10/boss/photo/redux">here</a>
...
the <a href="dr10/imaging/images.php#atlas">images page</a> for
...
href="dr10/algorithms/fluxcal.php">calibration</a>. These scans are
