...
You can use the SDSS <a href="http://skyserver.sdss3.org/dr10/en/">Catalog Archive Server</a> to generate a finding
chart to help plan these observations.</p>

<ol>

<li>Go to the <a href="http://skyserver.sdss3.org/dr10/en/tools/chart/chart.aspx">Finding Chart</a> tool.
