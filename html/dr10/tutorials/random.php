...
href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">SQL Search</a>.
To learn more about SQL, see SkyServer's <a href="http://skyserver.sdss3.org/dr10/en/help/howto/search">SQL Tutorial</a>
and guide to <a href="http://skyserver.sdss3.org/dr10/en/help/docs/sql_help.aspx">Using SQL with SkyServer</a>.</p>

<ol>

<li>Go to the <a href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">SQL Search</a> page.
