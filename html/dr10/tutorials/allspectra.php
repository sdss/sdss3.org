...
href="dr10/spectro/spectro_access.php">spectroscopic data access</a>
page.</p>
...
these files is given in the <a href="dr10/data_access/">data access
page</a>.
</p>
...
rsync -nrtkvz --include "26" --include "103" --include "104" \
  --include "v5_5_12" --include "[0-9][0-9][0-9][0-9]" \
  --include "spPlate*fits" --include "spZ*fits" \
  --exclude "*" rsync://data.sdss3.org/dr10/sdss/spectro/redux/ redux/
</pre>
...
subset of plates, since this full rsync is almost 1&nbsp;TB of data.</p>

<p>We also have a
<a href="dr10/tutorials/spPlate-dr10.txt">list of URLs</a>
...
par = yanny.yanny(os.path.join(os.getenv('SPECTRO_REDUX'),'plates-dr10.par'))
base = 'http://data.sdss3.org/sas/dr10/sdss/spectro/redux/{0}/{1:04d}/spPlate-{1:04d}-{2:5d}.fits\n'
url = [base.format(
    par['PLATES']['run2d'][k],
    par['PLATES']['plate'][k],
    par['PLATES']['mjd'][k])
...
<p><a href="dr10/software/">Software in idlspec2d</a> can be used to
...
href="http://data.sdss3.org/sas/dr10/sdss/spectro/redux/plates-dr10.par">official
list of DR10 plates</a>. Do not trust any results from a plate-mjd that
...
<p>
You will want the <a href="dr10/algorithms/legacy_tiling.php">tiling
information</a>.</p>
