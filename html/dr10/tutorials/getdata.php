...
href="http://skyserver.sdss3.org/dr10/">Catalog Archive Server</a> to find all
...
<a href="http://skyserver.sdss3.org/dr10/en/tools/search/iqs.aspx">Imaging Query Form</a>.
For absolute magnitude (and any other criteria), you can write queries in
<a href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">SQL</a>.</p>
...
<ul>
    <li><a href="dr10/tutorials/getdata.php#iqs">Using the Imaging Query Form</a></li>
    <li><a href="dr10/tutorials/getdata.php#radec">Find by Position</a></li>
    <li><a href="dr10/tutorials/getdata.php#magcolor">Find by Magnitude or Color</a></li>
    <li><a href="dr10/tutorials/getdata.php#absmag">Find by Absolute Magnitude</a></li>
</ul>

<h3 id="iqs">Using the <a href="http://skyserver.sdss3.org/dr10/en/tools/search/iqs.aspx">Imaging Query Form</a></h3>
...
<h3 id="radec">Find by <a href="http://skyserver.sdss3.org/dr10/en/tools/search/iqs.aspx">Position</a></h3>
...
<h3 id="magcolor">Find by <a href="http://skyserver.sdss3.org/dr10/en/tools/search/iqs.aspx">Magnitude or Color</a></h3>
...
<ol>
  ...
  <li>You can also search for the presence or absence of specific <em>flags</em>. See the tutorial <a href="dr10/tutorials/flags.php">Find out if SDSS's imaging data for an object are reliable?</a>
...
<h3 id="absmag">Find by <a href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">Absolute Magnitude</a></h3>
...
<p>Unfortunately, the Imaging Query Form allows you to search only by apparent magnitude, which is what is observed and stored in the
   database. To find objects by absolute magnitude, you will need to perform a <a href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">
   SQL search</a>.</p>
