...
is through the <a href="http://skyserver.sdss3.org/casjobs/">DR9 Catalog Archive Server (CAS)</a>.
...
to estimates of stellar parameters from the SSPP. If you would like to access the data using some
     other system, please go to the <a href="dr10/data_access/">Data Access for SDSS DR9</a> page. If you are looking for more basic information about SEGUE, please go to the <a href="dr10/tutorials/segue_getting_started.php">Getting Started with SEGUE</a> page. </p>
...
<li><a href="dr10/tutorials/segue_sqlcookbook.php#SQLBasics">The Basics of SQL</a>
       <ul>
       <li><a href="dr10/tutorials/segue_sqlcookbook.php#Functions">Useful Functions for SEGUE</a></li>
       <li><a href="dr10/tutorials/segue_sqlcookbook.php#Join">Combining Information From Different Tables</a></li>
       <li><a href="dr10/tutorials/segue_sqlcookbook.php#Quality">Ensuring Data Quality</a>
           <ul>
           <li><a href="dr10/tutorials/segue_sqlcookbook.php#PlateQuality">Plate Quality</a></li>
           <li><a href="dr10/tutorials/segue_sqlcookbook.php#RVCuts">Radial Velocity Quality</a></li>
           <li><a href="dr10/tutorials/segue_sqlcookbook.php#SNCuts">S/N Quality</a></li>
           <li><a href="dr10/tutorials/segue_sqlcookbook.php#Flags">SSPP Flags</a></li>
	   <li><a href="dr10/tutorials/segue_sqlcookbook.php#Caveats">Caveats</a></li>
          </ul>
       </li>
       <li><a href="dr10/tutorials/segue_sqlcookbook.php#Cookbook">Dive Right In: Some Sample Queries</a></li>
       </ul>
</li>
</ul>
...
<h2 id="Tables">SEGUE Tables in the DR9 Catalog Archive Server</h2>

<p> There are a number of tables in the DR9 CAS which are used to
access photometric and spectroscopic information. These
tables are documented in the <a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx">Schema Browser</a> (select the Tables menu tab). All of these table can be linked together in various ways using SQL queries.
We have listed some of the tables that are particularly useful for SEGUE below. </p>
<ul>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+SpecObjAll+U">SpecObjAll</a> -- For all spectra, plate, mjd, fiber, ra, dec</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+sppParams+U">sppParams</a> -- [Fe/H], log g, T<sub>eff</sub>, Radial Velocity for all stellar objects</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+sppLines+U">sppLines</a> -- Equivalent widths for common lines in stars</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+PhotoObjAll+U">PhotoObjAll</a> -- Photometric information for all stars </li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+Star+V">Star</a> -- Subset (View) of PhotoObjAll table with all Primary Stellar photometric detections.</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+segueTargetAll+U">SegueTargetAll</a> -- Target selection flags for all photometric objects</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+Plate2Target+U">Plate2Target</a> -- Matches plates to targets observed on that line of sight</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+ProperMotions+U">ProperMotions</a> -- Proper motions of the photometry</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+SpecPhotoAll+U">SpecPhotoAll</a> -- pre-determined match between SpecObjAll and PhotoObjAll (matched on flux, not position)</li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+PlateX+U">PlateX</a> -- Table of all plates, plate centers in RA, Dec, programnames </li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+SpecDR7+U">SpecDR7</a> -- Spatial cross-match between DR7 and DR8/DR9 Spectroscopy </li>
<li><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+PhotoObjDR7+U">PhotoObjDR7</a> -- Spatial cross-match between DR7 and DR8/DR9 Photometry </li>
</ul>
...
SDSS-III spectroscopy is available at the <a href="dr10/spectro/spectro_basics.php">
...
and SQL, we highly recommend you use the
 <a href="http://skyserver.sdss3.org/dr10/en/help/howto/search/">SQL Tutorial</a> and SDSSIII <a href="http://skyserver.sdss3.org/dr10/en/help/docs/realquery.aspx">SQL Sample Queries</a>. </p>
...
or <a href="http://skyserver.sdss3.org/dr10/en/help/download/sqlcl/default.aspx">Python</a>. Both
...
available in the <a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx">
...
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fDMS+F">fDMS</a>                                    </td><td>Converts declination in degrees to &plusmn;dd:mm:ss.ss notation </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fDocColumns+F">fDocColumns</a>                      </td><td> Returns information about all of the columns in a particular data table, including
data type and descriptions of the parameters </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fDocFunctionParams+F">fDocFunctionParams</a>        </td><td>Provides information about the input and output parameters for a specified function </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetLat+F">fGetLat</a>                              </td><td>Converts a 3-vector to Latitude </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetLon+F">fGetLon</a>                              </td><td>Converts a 3-vector to Longitude </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetNearbyObjEq+F">fGetNearbyObjEq</a>              </td><td>Given an RA and Dec, this function will return a table of all primary photometric objects
within a specified distance (in arcminutes) of the point </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetNearbySpecObjEq+F">fGetNearbySpecObjEq</a>      </td><td>Given an RA and Dec, this function will return all primary spectroscopic objects
within a specified distance (in arcminutes) of the point </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetNearestSpecObjIdEq+F">fGetNearestSpecObjIdEq</a></td><td>Searches within a specified radius about a given RA and Dec for the nearest scienceprimary
spectroscopic observation </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetObjectsEq+F">fGetObjectsEq</a>                  </td><td>Returns all objects within a specified radius of a given RA and Dec </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fGetObjFromRect+F">fGetObjFromRect</a>              </td><td>Returns a table of objects within a rectangle defined by two RA and Dec pairs</td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fHMS+F">fHMS</a>                                    </td><td>Converts RA from degrees to hh:mm:ss.ss notation </td></tr>
<tr><td><a href="http://skyserver.sdss3.org/dr10/en/help/browser/browser.aspx#&&history=description+fSpecDescription+F">fSpecDescription</a>            </td><td>Returns a string indicating class, status and zWarning for a given specObj </td></tr>
</table>
...
object via <a href="dr10/algorithms/match.php">RA and Dec
...
<a href="http://skyserver.sdss3.org/dr10/en/help/docs/realquery.aspx#outer">
...
present in a sample selected using criteria on <i>isBest</i> and <i>isPrimary</i>. More information about determining the plate quality is available <a href="dr10/spectro/catalogs.php">here</a>. </p>
...
your queries and select on that. The <a href="dr10/tutorials/segue_sqlcookbook.php#SNCuts">S/N quality</a>
...
detailed <a href="dr10/spectro/sspp_flags.php">here</a>.
</p>
...
one must also take into account other <a href="dr10/spectro/caveats.php#Segue_Caveats">caveats</a>
...
These, in addition to general SDSS spectroscopy <a href="dr10/spectro/caveats.php">caveats</a>
...
<td valign="top">
<ul>
<li><a href="dr10/tutorials/segue_sqlcookbook.php#RADEC">Rectangular RA and Dec Search</a></li>
<li><a href="dr10/tutorials/segue_sqlcookbook.php#Program_ID">Selecting by Survey and Programname</a> </li>
<li><a href="dr10/tutorials/segue_sqlcookbook.php#Category_ID">Extracting Specific Stellar Categories</a> </li>
</ul></td>
<td valign="top">
<ul>
<li><a href="dr10/tutorials/segue_sqlcookbook.php#Stellar_Params">Extracting Stellar Parameters</a> </li>
<li><a href="dr10/tutorials/segue_sqlcookbook.php#Col_Mag_Cuts">Color and Magnitude Cuts, with Join</a> </li>
<li><a href="dr10/tutorials/segue_sqlcookbook.php#Phot_by_Plate">Extract Photometric Targets for Particular Plate</a> </li>
</ul>
</td>
</tr>
</table>
...
<i>JOIN</i> statements are briefly described <a href="dr10/tutorials/segue_sqlcookbook.php#Join">here</a> and
on the <a href="http://skyserver.sdss3.org/dr10/en/help/docs/realquery.aspx">DR9 Sample SQL Queries</a>, </p>
...
<a href="dr10/spectro/caveats.php#Orphans">Missing DR9 Photometry</a>. </p>
...
or low latitudes. These are detailed in the <a href="dr10/algorithms/segue_plate_table.php">
...
for each of the surveys on the <a href="dr10/algorithms/segue_target_selection.php">Target Selection</a>
page. The organizational scheme for these parameters is described in the <a href="dr10/algorithms/segue_bit_guide.php">
Bit Guide</a>. </p>
...
<a href="dr10/algorithms/segue_plate_table.php">SEGUE Plates page</a>. Detailed information
on the changing criteria is available at the <a href="dr10/algorithms/segue_previous_tselec.php">
...
for multiple spectral types, resulting in it having <a href="dr10/algorithms/segue_bit_guide.php">multiple bits set</a>.
...
<a href="dr10/tutorials/segue_sqlcookbook.php#Join">Joins</a>. </p>
<pre>
SELECT top 10
sp.plate, sp.mjd, sp.fiberid, sp.specobjid, sp.bestobjid,
sp.elodiervfinal, sp.teffadop, sp.fehadop, sp.loggadop,
...
<a href="dr10/tutorials/segue_sqlcookbook.php#Functions">SQL function</a>.
