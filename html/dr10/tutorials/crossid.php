...
href="http://skyserver.sdss3.org/dr10/en/">Catalog
Archive Server</a> to see what those objects look like in the SDSS. This is especially useful when looking for
optical counterparts to objects seen in other wavelengths. The tool to do this is the
<a href="http://skyserver.sdss3.org/dr10/en/tools/crossid/crossid.aspx">Imaging 
...
href="http://skyserver.sdss3.org/dr10/en/tools/crossid/crossid.aspx">Cross-ID tool</a></h3>
...
<li><p>In the <i>Search Type</i> dropdown menu, choose the type of search that you want to do. The options are:</p>
   ...
   <ul>
     <li><i>The nearest primary object</i>:   The single <a href="dr10/help/glossary.php#primary">primary</a>
     ...
     whether or not it is a <a href="dr10/help/glossary.php#primary">primary</a>
     observation.</li>

     <li><i>All nearby objects</i>: All objects within your specified search radius.</li>

     <li><i>All nearby primary objects</i>:  All <a href="dr10/help/glossary.php#primary">primary</a> observations of
...
<a href="http://skyserver.sdss3.org/dr10/en/tools/explore/obj.aspx">Explore</a> tool, which will
...
<h3 id="thumbnails">Get SDSS <a href="http://skyserver.sdss3.org/dr10/en/tools/chart/list.aspx">thumbnails</a></h3>
...
the <a href="http://skyserver.sdss3.org/dr10/en/tools/chart/list.aspx">Image List</a>
...
href="http://skyserver.sdss3.org/dr10/en/tools/chart/navi.aspx">Navigate</a>
...
<a href="http://skyserver.sdss3.org/dr10/en/tools/explore/obj.aspx">Explore</a>
