...
in SDSS data with an <a href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">SQL Search</a>
...
<p>To learn more about SQL, see SkyServer's <a href="http://skyserver.sdss3.org/dr10/en/help/howto/search">SQL Tutorial</a>
and guide to <a href="http://skyserver.sdss3.org/dr10/en/help/docs/sql_help.aspx">Using SQL with SkyServer</a>.</p>

<ol>

<li><p>In the large textbox of the <a href="http://skyserver.sdss3.org/dr10/en/tools/search/sql.aspx">SQL Search</a> tool,
...
<a href="http://skyserver.sdss3.org/dr10/en/tools/chart/list.aspx">Image List</a> tool. From
the astronomers' main page, look under <i>Advanced Tools</i>. From the public main page, look under
<i>SkyServer Tools</i>.</li>

</ol>

<h3>View <a href="http://skyserver.sdss3.org/dr10/en/tools/chart/list.aspx">thumbnails</a></h3>
